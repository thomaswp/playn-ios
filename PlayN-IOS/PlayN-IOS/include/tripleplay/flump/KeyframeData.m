...
+ (id<PythagorasFIPoint>)getPointWithPlaynCoreJson_Object:(id<PlaynCoreJson_Object>)json
  ...
  id<PlaynCoreJson_TypedArray> array = [((id<PlaynCoreJson_Object>) nil_chk(json)) getArrayWithNSString:field withIOSClass:[IOSClass classWithClass:[JavaLangFloat class]]];
  return (array != nil) ? [[PythagorasFPoint alloc] initWithFloat:[((JavaLangFloat *) nil_chk([((id<PlaynCoreJson_TypedArray>) nil_chk(array)) getWithInt:0])) floatValue] withFloat:[((JavaLangFloat *) nil_chk([((id<PlaynCoreJson_TypedArray>) nil_chk(array)) getWithInt:1])) floatValue]] : [[PythagorasFPoint alloc] initWithFloat:defX withFloat:defY];
}
