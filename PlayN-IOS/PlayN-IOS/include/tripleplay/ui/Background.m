...
- (id<PlaynCoreLayer>)createSolidLayerWithInt:(int)color
  ...
  return [((id<PlaynCoreGraphics>) [PlaynCorePlayN graphics]) createImmediateLayerWithPlaynCoreImmediateLayer_Renderer:[[TripleplayUiBackground_$1 alloc] initWithTripleplayUiBackground:self withInt:color withFloat:width withFloat:height]];
}
