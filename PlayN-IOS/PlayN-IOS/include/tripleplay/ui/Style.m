...
+ (PlaynCoreTextFormat *)createTextFormatWithTripleplayUiElement:(TripleplayUiElement *)elem {
  PlaynCoreTextFormat *format = [((PlaynCoreTextFormat *) nil_chk([((PlaynCoreTextFormat *) [[PlaynCoreTextFormat alloc] init]) withFontWithPlaynCoreFont:[TripleplayUiStyles resolveStyleWithTripleplayUiElement:elem withTripleplayUiStyle:TripleplayUiStyle_FONT_]])) withAlignmentWithPlaynCoreTextFormat_AlignmentEnum:[TripleplayUiStyle toAlignmentWithTripleplayUiStyle_HAlignEnum:[TripleplayUiStyles resolveStyleWithTripleplayUiElement:elem withTripleplayUiStyle:TripleplayUiStyle_HALIGN_]]];
  return format;
}
...
+ (TripleplayUtilEffectRenderer *)createEffectRendererWithTripleplayUiElement:(TripleplayUiElement *)elem {
  switch ([[TripleplayUiStyles resolveStyleWithTripleplayUiElement:elem withTripleplayUiStyle:TripleplayUiStyle_TEXT_EFFECT_] ordinal]) {
    ...
    return [[TripleplayUtilEffectRenderer_PixelOutline alloc] initWithInt:[((JavaLangInteger *) nil_chk([TripleplayUiStyles resolveStyleWithTripleplayUiElement:elem withTripleplayUiStyle:TripleplayUiStyle_HIGHLIGHT_])) intValue]];
    case TripleplayUiStyle_TextEffect_VECTOR_OUTLINE:
    return [[TripleplayUtilEffectRenderer_VectorOutline alloc] initWithInt:[((JavaLangInteger *) nil_chk([TripleplayUiStyles resolveStyleWithTripleplayUiElement:elem withTripleplayUiStyle:TripleplayUiStyle_HIGHLIGHT_])) intValue] withFloat:[((JavaLangFloat *) nil_chk([TripleplayUiStyles resolveStyleWithTripleplayUiElement:elem withTripleplayUiStyle:TripleplayUiStyle_OUTLINE_WIDTH_])) floatValue] withPlaynCoreCanvas_LineCapEnum:[TripleplayUiStyles resolveStyleWithTripleplayUiElement:elem withTripleplayUiStyle:TripleplayUiStyle_OUTLINE_CAP_] withPlaynCoreCanvas_LineJoinEnum:[TripleplayUiStyles resolveStyleWithTripleplayUiElement:elem withTripleplayUiStyle:TripleplayUiStyle_OUTLINE_JOIN_]];
    case TripleplayUiStyle_TextEffect_SHADOW:
    return [[TripleplayUtilEffectRenderer_Shadow alloc] initWithInt:[((JavaLangInteger *) nil_chk([TripleplayUiStyles resolveStyleWithTripleplayUiElement:elem withTripleplayUiStyle:TripleplayUiStyle_SHADOW_])) intValue] withFloat:[((JavaLangFloat *) nil_chk([TripleplayUiStyles resolveStyleWithTripleplayUiElement:elem withTripleplayUiStyle:TripleplayUiStyle_SHADOW_X_])) floatValue] withFloat:[((JavaLangFloat *) nil_chk([TripleplayUiStyles resolveStyleWithTripleplayUiElement:elem withTripleplayUiStyle:TripleplayUiStyle_SHADOW_Y_])) floatValue]];
    default:
...
+ (void)initialize {
  if (self == [TripleplayUiStyle class]) {
    ...
    TripleplayUiStyle_SHADOW_ = [TripleplayUiStyle newStyleWithBOOL:YES withId:[JavaLangInteger valueOfWithInt:(int) 0x55000000]];
    TripleplayUiStyle_SHADOW_X_ = [TripleplayUiStyle newStyleWithBOOL:YES withId:[JavaLangFloat valueOfWithFloat:2.0f]];
    TripleplayUiStyle_SHADOW_Y_ = [TripleplayUiStyle newStyleWithBOOL:YES withId:[JavaLangFloat valueOfWithFloat:2.0f]];
    TripleplayUiStyle_OUTLINE_WIDTH_ = [TripleplayUiStyle newStyleWithBOOL:YES withId:[JavaLangFloat valueOfWithFloat:1.0f]];
    TripleplayUiStyle_OUTLINE_CAP_ = [TripleplayUiStyle newStyleWithBOOL:YES withId:[PlaynCoreCanvas_LineCapEnum ROUND]];
    TripleplayUiStyle_OUTLINE_JOIN_ = [TripleplayUiStyle newStyleWithBOOL:YES withId:[PlaynCoreCanvas_LineJoinEnum ROUND]];
    ...
    TripleplayUiStyle_FONT_ = [TripleplayUiStyle newStyleWithBOOL:YES withId:[((id<PlaynCoreGraphics>) nil_chk([PlaynCorePlayN graphics])) createFontWithNSString:@"Helvetica" withPlaynCoreFont_StyleEnum:[PlaynCoreFont_StyleEnum PLAIN] withFloat:16]];
    ...
    TripleplayUiStyle_BACKGROUND_ = [TripleplayUiStyle newStyleWithBOOL:NO withId:[TripleplayUiBackground blank]];
    TripleplayUiStyle_ICON_POS_ = [[TripleplayUiStyle_PosStyle alloc] init];
    TripleplayUiStyle_ICON_GAP_ = [TripleplayUiStyle newStyleWithBOOL:NO withId:[JavaLangInteger valueOfWithInt:2]];
    TripleplayUiStyle_ICON_CUDDLE_ = [TripleplayUiStyle newFlagWithBOOL:NO withBOOL:NO];
    TripleplayUiStyle_ACTION_SOUND_ = [TripleplayUiStyle newStyleWithBOOL:NO withId:(id<PlaynCoreSound>) nil];
  }
}
...
- (id)init {
  if ((self = [super initWithBOOL:NO])) {
    left_ = [self isWithId:[TripleplayUiStyle_HAlignEnum LEFT]];
    right_ = [self isWithId:[TripleplayUiStyle_HAlignEnum RIGHT]];
    center_ = [self isWithId:[TripleplayUiStyle_HAlignEnum CENTER]];
  }
  return self;
}
...
- (id)init {
  if ((self = [super initWithBOOL:NO])) {
    top_ = [self isWithId:[TripleplayUiStyle_VAlignEnum TOP]];
    bottom_ = [self isWithId:[TripleplayUiStyle_VAlignEnum BOTTOM]];
    center_ = [self isWithId:[TripleplayUiStyle_VAlignEnum CENTER]];
  }
  return self;
}
...
- (id)init {
  if ((self = [super initWithBOOL:NO])) {
    left_ = [self isWithId:[TripleplayUiStyle_PosEnum LEFT]];
    above_ = [self isWithId:[TripleplayUiStyle_PosEnum ABOVE]];
    right_ = [self isWithId:[TripleplayUiStyle_PosEnum RIGHT]];
    below_ = [self isWithId:[TripleplayUiStyle_PosEnum BELOW]];
  }
  return self;
}
...
- (id)init {
  if ((self = [super initWithBOOL:YES])) {
    outline_ = [self isWithId:[TripleplayUiStyle_TextEffectEnum PIXEL_OUTLINE]];
    pixelOutline_ = [self isWithId:[TripleplayUiStyle_TextEffectEnum PIXEL_OUTLINE]];
    vectorOutline_ = [self isWithId:[TripleplayUiStyle_TextEffectEnum VECTOR_OUTLINE]];
    shadow_ = [self isWithId:[TripleplayUiStyle_TextEffectEnum SHADOW]];
    none_ = [self isWithId:[TripleplayUiStyle_TextEffectEnum NONE]];
  }
  return self;
}
...
- (id)initWithBOOL:(BOOL)inherited
  ...
  if ((self = [super initWithBOOL:inherited])) {
    off_ = [self isWithId:[JavaLangBoolean valueOfWithBOOL:NO]];
    on_ = [self isWithId:[JavaLangBoolean valueOfWithBOOL:YES]];
