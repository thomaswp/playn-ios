...
#if !TripleplayUiLayoutBorderLayout_RESTRICT
#define TripleplayUiLayoutBorderLayout_INCLUDE_ALL 1
#endif
#undef TripleplayUiLayoutBorderLayout_RESTRICT

#if !defined (_TripleplayUiLayoutBorderLayout_) && (TripleplayUiLayoutBorderLayout_INCLUDE_ALL || TripleplayUiLayoutBorderLayout_INCLUDE)
#define _TripleplayUiLayoutBorderLayout_
...
#if !defined (_TripleplayUiLayoutBorderLayout_Constraint_) && (TripleplayUiLayoutBorderLayout_INCLUDE_ALL || TripleplayUiLayoutBorderLayout_Constraint_INCLUDE)
#define _TripleplayUiLayoutBorderLayout_Constraint_
...
@property (nonatomic, strong) TripleplayUiLayoutBorderLayout_PositionEnum *_pos;
...
#if !defined (_TripleplayUiLayoutBorderLayout_Slots_) && (TripleplayUiLayoutBorderLayout_INCLUDE_ALL || TripleplayUiLayoutBorderLayout_Slots_INCLUDE)
#define _TripleplayUiLayoutBorderLayout_Slots_

@class PythagorasFDimension;
@class PythagorasFRectangle;
@class TripleplayUiElement;
@class TripleplayUiElements;
@class TripleplayUiLayoutBorderLayout;
@class TripleplayUiLayoutBorderLayout_Constraint;
@class TripleplayUiLayoutBorderLayout_PositionEnum;
...
@property (nonatomic, strong) TripleplayUiLayoutBorderLayout *this$0;
@property (nonatomic, strong) id<JavaUtilMap> elements;
...
#if !defined (_TripleplayUiLayoutBorderLayout_PositionEnum_) && (TripleplayUiLayoutBorderLayout_INCLUDE_ALL || TripleplayUiLayoutBorderLayout_PositionEnum_INCLUDE)
#define _TripleplayUiLayoutBorderLayout_PositionEnum_
...
@property (nonatomic, strong) TripleplayUiLayoutBorderLayout_Constraint *unstretched;
@property (nonatomic, strong) TripleplayUiLayoutBorderLayout_Constraint *stretched;
