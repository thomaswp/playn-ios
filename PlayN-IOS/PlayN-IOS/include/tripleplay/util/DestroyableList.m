...
#include "tripleplay/util/DestroyableList.h"
...
- (id)initWithInt:(int)initCap {
  if ((self = [super init])) {
    ...
    _data_ = [IOSObjectArray arrayWithLength:initCap type:[IOSClass classWithClass:[NSObject class]]];
  }
  return self;
}
...
- (id)addWithId:(id<TripleplayUtilDestroyable>)elem {
  ...
  (void) [((IOSObjectArray *) nil_chk(_data_)) replaceObjectAtIndex:_size_++ withObject:elem];
  return elem;
}
...
- (id)addWithInt:(int)index
  ...
  (void) [((IOSObjectArray *) nil_chk(_data_)) replaceObjectAtIndex:index withObject:elem];
  _size_++;
  return elem;
}
...
- (id)removeWithInt:(int)index {
  ...
  (void) [((IOSObjectArray *) nil_chk(_data_)) replaceObjectAtIndex:--_size_ withObject:nil];
...
- (void)clear {
  ...
  for (int ii = 0, ll = _size_; ii < ll; ii++) {
    ...
    (void) [((IOSObjectArray *) nil_chk(data)) replaceObjectAtIndex:ii withObject:nil];
  }
  _size_ = 0;
}
...
- (void)ensureCapacityWithInt:(int)minCapacity {
  ...
  if (minCapacity > oldCapacity) {
    ...
    IOSObjectArray *newData = [IOSObjectArray arrayWithLength:newCapacity type:[IOSClass classWithClass:[NSObject class]]];
