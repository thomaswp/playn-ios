...
#if !TripleplayUtilColors_RESTRICT
#define TripleplayUtilColors_INCLUDE_ALL 1
#endif
#undef TripleplayUtilColors_RESTRICT

#if !defined (_TripleplayUtilColors_) && (TripleplayUtilColors_INCLUDE_ALL || TripleplayUtilColors_INCLUDE)
#define _TripleplayUtilColors_
