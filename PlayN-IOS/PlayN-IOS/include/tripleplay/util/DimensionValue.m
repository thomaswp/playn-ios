...
- (void)updateWidthWithFloat:(float)width {
  (void) [self updateWithId:[[PythagorasFDimension alloc] initWithFloat:width withFloat:[((id<PythagorasFIDimension>) ((id<PythagorasFIDimension>) [self get])) height]]];
}

- (void)updateHeightWithFloat:(float)height {
  (void) [self updateWithId:[[PythagorasFDimension alloc] initWithFloat:[((id<PythagorasFIDimension>) ((id<PythagorasFIDimension>) [self get])) width] withFloat:height]];
}
