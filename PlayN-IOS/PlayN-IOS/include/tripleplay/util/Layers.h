...
#if !TripleplayUtilLayers_RESTRICT
#define TripleplayUtilLayers_INCLUDE_ALL 1
#endif
#undef TripleplayUtilLayers_RESTRICT

#if !defined (_TripleplayUtilLayers_) && (TripleplayUtilLayers_INCLUDE_ALL || TripleplayUtilLayers_INCLUDE)
#define _TripleplayUtilLayers_
