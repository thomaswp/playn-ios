...
- (id)init {
  if ((self = [super init])) {
    ...
    _fmt_ = [((PlaynCoreTextFormat *) [[PlaynCoreTextFormat alloc] init]) withFontWithPlaynCoreFont:[((id<PlaynCoreGraphics>) [PlaynCorePlayN graphics]) createFontWithNSString:@"Helvetica" withPlaynCoreFont_StyleEnum:[PlaynCoreFont_StyleEnum PLAIN] withFloat:12]];
    _textColor_ = (int) 0xFF000000;
    _bgColor_ = (int) 0xFFFFFFFF;
    _image_ = [((id<PlaynCoreGraphics>) [PlaynCorePlayN graphics]) createImageWithFloat:1 withFloat:1];
    layer_ = [((id<PlaynCoreGraphics>) [PlaynCorePlayN graphics]) createImageLayerWithPlaynCoreImage:_image_];
  }
  return self;
}
...
- (void)update {
  ...
  if ([((id<PlaynCoreCanvasImage>) NIL_CHK(_image_)) width] < width || [((id<PlaynCoreCanvasImage>) NIL_CHK(_image_)) height] < height) {
    (void) [((id<PlaynCoreImageLayer>) NIL_CHK(layer_)) setImageWithPlaynCoreImage:_image_ = [((id<PlaynCoreGraphics>) [PlaynCorePlayN graphics]) createImageWithFloat:width withFloat:height]];
  }
...
- (id)init {
  if ((self = [super init])) {
    _frames_ = ((ReactValue *) [ReactValue createWithId:[JavaLangInteger valueOfWithInt:0]]);
    _shaderCreates_ = ((ReactValue *) [ReactValue createWithId:[JavaLangInteger valueOfWithInt:0]]);
    _fbCreates_ = ((ReactValue *) [ReactValue createWithId:[JavaLangInteger valueOfWithInt:0]]);
    _texCreates_ = ((ReactValue *) [ReactValue createWithId:[JavaLangInteger valueOfWithInt:0]]);
    _shaderBinds_ = ((ReactValue *) [ReactValue createWithId:[JavaLangInteger valueOfWithInt:0]]);
    _fbBinds_ = ((ReactValue *) [ReactValue createWithId:[JavaLangInteger valueOfWithInt:0]]);
    _texBinds_ = ((ReactValue *) [ReactValue createWithId:[JavaLangInteger valueOfWithInt:0]]);
    _rQuads_ = ((ReactValue *) [ReactValue createWithId:[JavaLangInteger valueOfWithInt:0]]);
    _rTris_ = ((ReactValue *) [ReactValue createWithId:[JavaLangInteger valueOfWithInt:0]]);
    _shaderFlushes_ = ((ReactValue *) [ReactValue createWithId:[JavaLangInteger valueOfWithInt:0]]);
    _quadShader_ = ((ReactValue *) [ReactValue createWithId:@""]);
    _trisShader_ = ((ReactValue *) [ReactValue createWithId:@""]);
...
- (void)update {
  _layout_ = [((id<PlaynCoreGraphics>) [PlaynCorePlayN graphics]) layoutTextWithNSString:[NSString valueOf:[((ReactValue *) NIL_CHK(val$label_)) get]] withPlaynCoreTextFormat:this$0_._fmt];
}
...
- (void)update {
  _vlayout_ = [((id<PlaynCoreGraphics>) [PlaynCorePlayN graphics]) layoutTextWithNSString:[NSString valueOf:[((ReactValue *) NIL_CHK(val$value_)) get]] withPlaynCoreTextFormat:this$0_._fmt];
}
