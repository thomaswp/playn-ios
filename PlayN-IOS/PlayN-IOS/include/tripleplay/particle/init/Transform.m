...
withJavaLangFloatArray:(IOSFloatArray *)data
  ...
  [((IOSFloatArray *) NIL_CHK(data)) replaceFloatAtIndex:start + TripleplayParticleParticleBuffer_M00 withFloat:val$m00_];
  [((IOSFloatArray *) NIL_CHK(data)) replaceFloatAtIndex:start + TripleplayParticleParticleBuffer_M01 withFloat:val$m01_];
  [((IOSFloatArray *) NIL_CHK(data)) replaceFloatAtIndex:start + TripleplayParticleParticleBuffer_M10 withFloat:val$m10_];
  [((IOSFloatArray *) NIL_CHK(data)) replaceFloatAtIndex:start + TripleplayParticleParticleBuffer_M11 withFloat:val$m11_];
  [((IOSFloatArray *) NIL_CHK(data)) replaceFloatAtIndex:start + TripleplayParticleParticleBuffer_TX withFloat:val$tx_];
  [((IOSFloatArray *) NIL_CHK(data)) replaceFloatAtIndex:start + TripleplayParticleParticleBuffer_TY withFloat:val$ty_];
}
...
withJavaLangFloatArray:(IOSFloatArray *)data
              withInt:(int)start OBJC_METHOD_FAMILY_NONE {
  [((IOSFloatArray *) NIL_CHK(data)) replaceFloatAtIndex:start + TripleplayParticleParticleBuffer_M00 withFloat:[data floatAtIndex:start + TripleplayParticleParticleBuffer_M00] * val$scale_];
  [((IOSFloatArray *) NIL_CHK(data)) replaceFloatAtIndex:start + TripleplayParticleParticleBuffer_M01 withFloat:[data floatAtIndex:start + TripleplayParticleParticleBuffer_M01] * val$scale_];
  [((IOSFloatArray *) NIL_CHK(data)) replaceFloatAtIndex:start + TripleplayParticleParticleBuffer_M10 withFloat:[data floatAtIndex:start + TripleplayParticleParticleBuffer_M10] * val$scale_];
  [((IOSFloatArray *) NIL_CHK(data)) replaceFloatAtIndex:start + TripleplayParticleParticleBuffer_M11 withFloat:[data floatAtIndex:start + TripleplayParticleParticleBuffer_M11] * val$scale_];
}
...
withJavaLangFloatArray:(IOSFloatArray *)data
  ...
  [((IOSFloatArray *) NIL_CHK(data)) replaceFloatAtIndex:start + TripleplayParticleParticleBuffer_M00 withFloat:[data floatAtIndex:start + TripleplayParticleParticleBuffer_M00] * scale_];
  [((IOSFloatArray *) NIL_CHK(data)) replaceFloatAtIndex:start + TripleplayParticleParticleBuffer_M01 withFloat:[data floatAtIndex:start + TripleplayParticleParticleBuffer_M01] * scale_];
  [((IOSFloatArray *) NIL_CHK(data)) replaceFloatAtIndex:start + TripleplayParticleParticleBuffer_M10 withFloat:[data floatAtIndex:start + TripleplayParticleParticleBuffer_M10] * scale_];
  [((IOSFloatArray *) NIL_CHK(data)) replaceFloatAtIndex:start + TripleplayParticleParticleBuffer_M11 withFloat:[data floatAtIndex:start + TripleplayParticleParticleBuffer_M11] * scale_];
}
...
- (id)initWithPlaynCoreLayer:(id<PlaynCoreLayer>)capture$0 {
  if ((self = [super init])) {
    ...
    xform_ = [[((id<PlaynCoreGraphics>) [PlaynCorePlayN graphics]) ctx] createTransform];
...
withJavaLangFloatArray:(IOSFloatArray *)data
              withInt:(int)start OBJC_METHOD_FAMILY_NONE {
  [((IOSFloatArray *) NIL_CHK(data)) replaceFloatAtIndex:start + TripleplayParticleParticleBuffer_TX withFloat:val$x_ + [((TripleplayUtilRandoms *) NIL_CHK(val$rando_)) getFloatWithFloat:val$width_]];
  [((IOSFloatArray *) NIL_CHK(data)) replaceFloatAtIndex:start + TripleplayParticleParticleBuffer_TY withFloat:val$y_ + [((TripleplayUtilRandoms *) NIL_CHK(val$rando_)) getFloatWithFloat:val$height_]];
}
...
withJavaLangFloatArray:(IOSFloatArray *)data
              withInt:(int)start OBJC_METHOD_FAMILY_NONE {
  [((IOSFloatArray *) NIL_CHK(data)) replaceFloatAtIndex:start + TripleplayParticleParticleBuffer_TX withFloat:[data floatAtIndex:start + TripleplayParticleParticleBuffer_TX] + [((TripleplayUtilRandoms *) NIL_CHK(val$rando_)) getInRangeWithFloat:-val$noise_ withFloat:val$noise_]];
  [((IOSFloatArray *) NIL_CHK(data)) replaceFloatAtIndex:start + TripleplayParticleParticleBuffer_TY withFloat:[data floatAtIndex:start + TripleplayParticleParticleBuffer_TY] + [((TripleplayUtilRandoms *) NIL_CHK(val$rando_)) getInRangeWithFloat:-val$noise_ withFloat:val$noise_]];
}
