...
- (void)addQuadWithFloat:(float)left
  ...
  (void) [((id<PlaynCoreGlGLBuffer_Float>) nil_chk([((id<PlaynCoreGlGLBuffer_Float>) nil_chk([((id<PlaynCoreGlGLBuffer_Float>) nil_chk(vertices_)) addWithFloatArray:data withInt:pstart withInt:10])) addWithFloat:left withFloat:top])) addWithFloat:0 withFloat:0];
  (void) [((id<PlaynCoreGlGLBuffer_Float>) nil_chk([((id<PlaynCoreGlGLBuffer_Float>) nil_chk([((id<PlaynCoreGlGLBuffer_Float>) nil_chk(vertices_)) addWithFloatArray:data withInt:pstart withInt:10])) addWithFloat:right withFloat:top])) addWithFloat:1 withFloat:0];
  (void) [((id<PlaynCoreGlGLBuffer_Float>) nil_chk([((id<PlaynCoreGlGLBuffer_Float>) nil_chk([((id<PlaynCoreGlGLBuffer_Float>) nil_chk(vertices_)) addWithFloatArray:data withInt:pstart withInt:10])) addWithFloat:left withFloat:bottom])) addWithFloat:0 withFloat:1];
  (void) [((id<PlaynCoreGlGLBuffer_Float>) nil_chk([((id<PlaynCoreGlGLBuffer_Float>) nil_chk([((id<PlaynCoreGlGLBuffer_Float>) nil_chk(vertices_)) addWithFloatArray:data withInt:pstart withInt:10])) addWithFloat:right withFloat:bottom])) addWithFloat:1 withFloat:1];
