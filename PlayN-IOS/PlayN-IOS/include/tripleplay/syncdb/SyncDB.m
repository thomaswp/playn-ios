...
withTripleplaySyncdbSetResolver:(id<TripleplaySyncdbSetResolver>)resolver {
  [PlaynCoreAsserts checkArgumentWithBOOL:![((id<JavaUtilSet>) NIL_CHK(TripleplaySyncdbSyncDB_SYNC_KEYS_)) containsWithId:name] withId:[NSString stringWithFormat:@"%@ is a reserved name.", name]];
  ReactRSet *rset = [[TripleplaySyncdbSyncDB_$3 alloc] initWithTripleplaySyncdbSyncDB:self withJavaUtilSet:((id<JavaUtilSet>) [self sgetWithNSString:name withTripleplaySyncdbCodec:codec]) withNSString:name withTripleplaySyncdbCodec:codec];
...
- (id)initWithTripleplaySyncdbSyncDB:(TripleplaySyncdbSyncDB *)outer$ {
  if ((self = [super init])) {
    this$0_ = outer$;
    _keys_ = [[TripleplaySyncdbSyncDB_map_StorageMap_$2 alloc] initWithTripleplaySyncdbSyncDB_map_StorageMap:self withJavaUtilSet:((id<JavaUtilSet>) [outer$ sgetWithNSString:[TripleplaySyncdbSyncDB mapKeysKeyWithNSString:val$prefix_] withTripleplaySyncdbCodec:val$keyCodec_])];
  }
  return self;
}
...
- (id)initWithTripleplaySyncdbSyncDB_map_StorageMap_$1:(TripleplaySyncdbSyncDB_map_StorageMap_$1 *)outer$ {
  if ((self = [super init])) {
    this$0_ = outer$;
    _keysIter_ = ((id<JavaUtilIterator>) [((id<JavaUtilSet>) NIL_CHK(outer$.this$0._keys)) iterator]);
  }
  return self;
}
