...
- (TripleplayAnimAnimation_Two *)tweenXYWithPlaynCoreLayer:(id<PlaynCoreLayer>)layer {
  return [self addWithId:[[TripleplayAnimAnimation_Two alloc] initWithTripleplayAnimAnimation_Value:[TripleplayAnimAnimBuilder onXWithPlaynCoreLayer:layer] withTripleplayAnimAnimation_Value:[TripleplayAnimAnimBuilder onYWithPlaynCoreLayer:layer]]];
}
...
- (TripleplayAnimAnimation_Two *)tweenScaleXYWithPlaynCoreLayer:(id<PlaynCoreLayer>)layer {
  return [self addWithId:[[TripleplayAnimAnimation_Two alloc] initWithTripleplayAnimAnimation_Value:[TripleplayAnimAnimBuilder onScaleXWithPlaynCoreLayer:layer] withTripleplayAnimAnimation_Value:[TripleplayAnimAnimBuilder onScaleYWithPlaynCoreLayer:layer]]];
}
...
- (TripleplayAnimAnimation_One *)tweenWithTripleplayAnimAnimation_Value:(id<TripleplayAnimAnimation_Value>)value {
  return [self addWithId:[[TripleplayAnimAnimation_One alloc] initWithTripleplayAnimAnimation_Value:value]];
}
...
- (TripleplayAnimAnimation_Flip *)flipbookWithPlaynCoreImageLayer:(id<PlaynCoreImageLayer>)layer
  ...
  return [self addWithId:[[TripleplayAnimAnimation_Flip alloc] initWithPlaynCoreImageLayer:layer withTripleplayAnimFlipbook:book]];
}

- (TripleplayAnimAnimation_Flip *)flipbookWithPlaynCoreGroupLayer:(id<PlaynCoreGroupLayer>)box
                                       withTripleplayAnimFlipbook:(TripleplayAnimFlipbook *)book {
  id<PlaynCoreImageLayer> image = [((id<PlaynCoreGraphics>) nil_chk([PlaynCorePlayN graphics])) createImageLayer];
...
- (TripleplayAnimAnimation *)flipbookAtWithPlaynCoreGroupLayer:(id<PlaynCoreGroupLayer>)parent
                                                     ...
                                                     withFloat:(float)y
                                    withTripleplayAnimFlipbook:(TripleplayAnimFlipbook *)book {
  id<PlaynCoreGroupLayer> box = [((id<PlaynCoreGraphics>) nil_chk([PlaynCorePlayN graphics])) createGroupLayer];
  (void) [((id<PlaynCoreGroupLayer>) nil_chk(box)) setTranslationWithFloat:x withFloat:y];
  return [((TripleplayAnimAnimBuilder *) nil_chk([((TripleplayAnimAnimation_Flip *) nil_chk([((TripleplayAnimAnimBuilder *) nil_chk([((TripleplayAnimAnimation_Action *) nil_chk([self addWithPlaynCoreGroupLayer:parent withPlaynCoreLayer:box])) then])) flipbookWithPlaynCoreGroupLayer:box withTripleplayAnimFlipbook:book])) then])) destroyWithPlaynCoreLayer:box];
}
...
- (TripleplayAnimAnimation_Shake *)shakeWithPlaynCoreLayer:(id<PlaynCoreLayer>)layer {
  return [self addWithId:[[TripleplayAnimAnimation_Shake alloc] initWithPlaynCoreLayer:layer]];
}

- (TripleplayAnimAnimation_Delay *)delayWithFloat:(float)duration {
  return [self addWithId:[[TripleplayAnimAnimation_Delay alloc] initWithFloat:duration]];
}

- (TripleplayAnimAnimBuilder *)repeatWithPlaynCoreLayer:(id<PlaynCoreLayer>)layer {
  return [((TripleplayAnimAnimation_Repeat *) nil_chk([self addWithId:[[TripleplayAnimAnimation_Repeat alloc] initWithPlaynCoreLayer:layer]])) then];
}

- (TripleplayAnimAnimation_Action *)actionWithJavaLangRunnable:(id<JavaLangRunnable>)action {
  return [self addWithId:[[TripleplayAnimAnimation_Action alloc] initWithJavaLangRunnable:action]];
}
...
- (void)run {
  (void) [((ReactValue *) nil_chk(val$value_)) updateWithId:[JavaLangInteger valueOfWithInt:[((JavaLangInteger *) nil_chk([((ReactValue *) nil_chk(val$value_)) get])) intValue] + val$amount_]];
}
