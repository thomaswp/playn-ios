...
- (void)init__WithTripleplayGameScreen:(TripleplayGameScreen *)oscreen
  ...
  _osx_ = [((id<PlaynCoreGroupLayer>) nil_chk(((TripleplayGameScreen *) nil_chk(oscreen)).layer)) tx];
  _osy_ = [((id<PlaynCoreGroupLayer>) nil_chk(((TripleplayGameScreen *) nil_chk(oscreen)).layer)) ty];
  (void) [((id<PlaynCoreGroupLayer>) nil_chk(((TripleplayGameScreen *) nil_chk(nscreen)).layer)) setTranslationWithFloat:_nsx_ withFloat:_nsy_];
}
...
- (BOOL)updateWithTripleplayGameScreen:(TripleplayGameScreen *)oscreen
  ...
  (void) [((id<PlaynCoreGroupLayer>) nil_chk(((TripleplayGameScreen *) nil_chk(oscreen)).layer)) setTranslationWithFloat:ox withFloat:oy];
  ...
  (void) [((id<PlaynCoreGroupLayer>) nil_chk(((TripleplayGameScreen *) nil_chk(nscreen)).layer)) setTranslationWithFloat:nx withFloat:ny];
...
- (void)completeWithTripleplayGameScreen:(TripleplayGameScreen *)oscreen
  ...
  (void) [((id<PlaynCoreGroupLayer>) nil_chk(((TripleplayGameScreen *) nil_chk(oscreen)).layer)) setTranslationWithFloat:_osx_ withFloat:_osy_];
}
