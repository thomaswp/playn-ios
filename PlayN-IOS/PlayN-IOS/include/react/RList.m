...
+ (ReactRList *)create {
  return ((ReactRList *) [ReactRList createWithJavaUtilList:[[JavaUtilArrayList alloc] init]]);
}
...
- (id<JavaUtilList>)subListWithInt:(int)fromIndex
                           withInt:(int)toIndex {
  return [[ReactRList alloc] initWithJavaUtilList:((id<JavaUtilList>) [((id<JavaUtilList>) NIL_CHK(_impl_)) subListWithInt:fromIndex withInt:toIndex])];
}
