...
- (IOSObjectArray *)findCrossing {
  IOSDoubleArray *edge1 = [[IOSDoubleArray alloc] initWithLength:8];
  IOSDoubleArray *edge2 = [[IOSDoubleArray alloc] initWithLength:8];
  IOSDoubleArray *points = [[IOSDoubleArray alloc] initWithLength:6];
  IOSDoubleArray *params = [[IOSDoubleArray alloc] initWithLength:6];
  IOSDoubleArray *mp1 = [[IOSDoubleArray alloc] initWithLength:2];
  IOSDoubleArray *cp1 = [[IOSDoubleArray alloc] initWithLength:2];
  IOSDoubleArray *mp2 = [[IOSDoubleArray alloc] initWithLength:2];
  IOSDoubleArray *cp2 = [[IOSDoubleArray alloc] initWithLength:2];
  ...
  return [((id<JavaUtilList>) NIL_CHK(isectPoints_)) toArrayWithNSObjectArray:[[IOSObjectArray alloc] initWithLength:[((id<JavaUtilList>) NIL_CHK(isectPoints_)) size] type:[IOSClass classWithClass:[PythagorasDIntersectPoint class]]]];
}
