...
#if !PythagorasDAbstractVector_RESTRICT
#define PythagorasDAbstractVector_INCLUDE_ALL 1
#endif
#undef PythagorasDAbstractVector_RESTRICT

#if !defined (_PythagorasDAbstractVector_) && (PythagorasDAbstractVector_INCLUDE_ALL || PythagorasDAbstractVector_INCLUDE)
#define _PythagorasDAbstractVector_

@class PythagorasDVector;

#define PythagorasDIVector_RESTRICT 1
#define PythagorasDIVector_INCLUDE 1
