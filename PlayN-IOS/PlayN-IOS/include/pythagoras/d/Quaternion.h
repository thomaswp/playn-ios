...
#if !PythagorasDQuaternion_RESTRICT
#define PythagorasDQuaternion_INCLUDE_ALL 1
#endif
#undef PythagorasDQuaternion_RESTRICT

#if !defined (_PythagorasDQuaternion_) && (PythagorasDQuaternion_INCLUDE_ALL || PythagorasDQuaternion_INCLUDE)
#define _PythagorasDQuaternion_
...
#define PythagorasDIQuaternion_RESTRICT 1
#define PythagorasDIQuaternion_INCLUDE 1
