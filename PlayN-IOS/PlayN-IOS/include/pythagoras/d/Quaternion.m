...
- (PythagorasDQuaternion *)setWithDoubleArray:(IOSDoubleArray *)values {
...
- (PythagorasDQuaternion *)fromVectorsWithPythagorasDIVector3:(id<PythagorasDIVector3>)from
  ...
  if (angle <= JavaLangMath_PI - PythagorasDMathUtil_EPSILON) {
    return [self fromAngleAxisWithDouble:angle withPythagorasDIVector3:[((PythagorasDVector3 *) nil_chk([((id<PythagorasDIVector3>) nil_chk(from)) crossWithPythagorasDIVector3:to])) normalizeLocal]];
  }
  ...
  return [self fromAngleAxisWithDouble:JavaLangMath_PI withPythagorasDIVector3:length < PythagorasDMathUtil_EPSILON ? [((PythagorasDVector3 *) nil_chk([((PythagorasDVector3 *) nil_chk(axis)) setWithDouble:-[((id<PythagorasDIVector3>) nil_chk(from)) z] withDouble:0.0f withDouble:[((id<PythagorasDIVector3>) nil_chk(from)) x]])) normalizeLocal] : [((PythagorasDVector3 *) nil_chk(axis)) multLocalWithDouble:1.0f / length]];
}
...
- (void)getWithDoubleArray:(IOSDoubleArray *)values {
  ...
  (*[((IOSDoubleArray *) nil_chk(values)) doubleRefAtIndex:3]) = w__;
}
...
- (PythagorasDQuaternion *)integrateWithPythagorasDIVector3:(id<PythagorasDIVector3>)velocity
  ...
  return [((PythagorasDQuaternion *) nil_chk([((PythagorasDQuaternion *) nil_chk(result)) setWithDouble:x__ + t * (qx * w__ + qy * z__ - qz * y__) withDouble:y__ + t * (qy * w__ + qz * x__ - qx * z__) withDouble:z__ + t * (qz * w__ + qx * y__ - qy * x__) withDouble:w__ + t * (-qx * x__ - qy * y__ - qz * z__)])) normalizeLocal];
}
