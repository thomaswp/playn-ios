...
#if !PythagorasDPoints_RESTRICT
#define PythagorasDPoints_INCLUDE_ALL 1
#endif
#undef PythagorasDPoints_RESTRICT

#if !defined (_PythagorasDPoints_) && (PythagorasDPoints_INCLUDE_ALL || PythagorasDPoints_INCLUDE)
#define _PythagorasDPoints_
