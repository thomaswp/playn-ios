...
#if !PythagorasDAffineTransform_RESTRICT
#define PythagorasDAffineTransform_INCLUDE_ALL 1
#endif
#undef PythagorasDAffineTransform_RESTRICT

#if !defined (_PythagorasDAffineTransform_) && (PythagorasDAffineTransform_INCLUDE_ALL || PythagorasDAffineTransform_INCLUDE)
#define _PythagorasDAffineTransform_
