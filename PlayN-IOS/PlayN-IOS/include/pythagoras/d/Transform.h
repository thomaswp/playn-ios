...
#if !PythagorasDTransform_RESTRICT
#define PythagorasDTransform_INCLUDE_ALL 1
#endif
#undef PythagorasDTransform_RESTRICT

#if !defined (_PythagorasDTransform_) && (PythagorasDTransform_INCLUDE_ALL || PythagorasDTransform_INCLUDE)
#define _PythagorasDTransform_
...
@protocol PythagorasDTransform < NSObject, JavaObject >
- (double)uniformScale;
