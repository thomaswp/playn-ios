...
#if !PythagorasDIVector3_RESTRICT
#define PythagorasDIVector3_INCLUDE_ALL 1
#endif
#undef PythagorasDIVector3_RESTRICT

#if !defined (_PythagorasDIVector3_) && (PythagorasDIVector3_INCLUDE_ALL || PythagorasDIVector3_INCLUDE)
#define _PythagorasDIVector3_

@class IOSDoubleArray;
@class JavaNioDoubleBuffer;
@class PythagorasDVector3;

@protocol PythagorasDIVector3 < NSObject, JavaObject >
- (double)x;
- (double)y;
- (double)z;
