...
#if !PythagorasDPath_RESTRICT
#define PythagorasDPath_INCLUDE_ALL 1
#endif
#undef PythagorasDPath_RESTRICT

#if !defined (_PythagorasDPath_) && (PythagorasDPath_INCLUDE_ALL || PythagorasDPath_INCLUDE)
#define _PythagorasDPath_
...
@property (nonatomic, strong) IOSDoubleArray *points;
...
#if !defined (_PythagorasDPath_Iterator_) && (PythagorasDPath_INCLUDE_ALL || PythagorasDPath_Iterator_INCLUDE)
#define _PythagorasDPath_Iterator_

@class IOSDoubleArray;
@class PythagorasDPath;
@protocol PythagorasDTransform;
...
@property (nonatomic, strong) PythagorasDPath *p;
