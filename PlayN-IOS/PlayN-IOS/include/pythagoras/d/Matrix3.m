...
- (PythagorasDMatrix3 *)setToRotationWithPythagorasDIVector3:(id<PythagorasDIVector3>)from
  ...
  return (angle < 0.0001f) ? [self setToIdentity] : [self setToRotationWithDouble:angle withPythagorasDIVector3:[((PythagorasDVector3 *) nil_chk([((id<PythagorasDIVector3>) nil_chk(from)) crossWithPythagorasDIVector3:to])) normalizeLocal]];
}
...
- (PythagorasDMatrix3 *)setToTransformWithPythagorasDIVector:(id<PythagorasDIVector>)translation
  ...
  return [((PythagorasDMatrix3 *) nil_chk([self setToRotationWithDouble:rotation])) setTranslationWithPythagorasDIVector:translation];
}

- (PythagorasDMatrix3 *)setToTransformWithPythagorasDIVector:(id<PythagorasDIVector>)translation
                                                  withDouble:(double)rotation
                                                  withDouble:(double)scale_ {
  return [((PythagorasDMatrix3 *) nil_chk([self setToRotationWithDouble:rotation])) setWithDouble:m00__ * scale_ withDouble:m10__ * scale_ withDouble:[((id<PythagorasDIVector>) nil_chk(translation)) x] withDouble:m01__ * scale_ withDouble:m11__ * scale_ withDouble:[((id<PythagorasDIVector>) nil_chk(translation)) y] withDouble:0.0f withDouble:0.0f withDouble:1.0f];
}
...
- (PythagorasDMatrix3 *)setToTransformWithPythagorasDIVector:(id<PythagorasDIVector>)translation
  ...
  return [((PythagorasDMatrix3 *) nil_chk([self setToRotationWithDouble:rotation])) setWithDouble:m00__ * sx withDouble:m10__ * sy withDouble:[((id<PythagorasDIVector>) nil_chk(translation)) x] withDouble:m01__ * sx withDouble:m11__ * sy withDouble:[((id<PythagorasDIVector>) nil_chk(translation)) y] withDouble:0.0f withDouble:0.0f withDouble:1.0f];
}
...
- (PythagorasDMatrix3 *)setWithDoubleArray:(IOSDoubleArray *)values {
...
- (PythagorasDMatrix3 *)transpose {
  return [self transposeWithPythagorasDMatrix3:[[PythagorasDMatrix3 alloc] init]];
}
...
- (PythagorasDMatrix3 *)multWithPythagorasDIMatrix3:(id<PythagorasDIMatrix3>)other {
  return [self multWithPythagorasDIMatrix3:other withPythagorasDMatrix3:[[PythagorasDMatrix3 alloc] init]];
}
...
- (PythagorasDMatrix3 *)addWithPythagorasDIMatrix3:(id<PythagorasDIMatrix3>)other {
  return [self addWithPythagorasDIMatrix3:other withPythagorasDMatrix3:[[PythagorasDMatrix3 alloc] init]];
}
...
- (PythagorasDMatrix3 *)multAffineWithPythagorasDIMatrix3:(id<PythagorasDIMatrix3>)other {
  return [self multAffineWithPythagorasDIMatrix3:other withPythagorasDMatrix3:[[PythagorasDMatrix3 alloc] init]];
}
...
- (PythagorasDMatrix3 *)invert {
  return [self invertWithPythagorasDMatrix3:[[PythagorasDMatrix3 alloc] init]];
}
...
- (PythagorasDMatrix3 *)invertAffine {
  return [self invertAffineWithPythagorasDMatrix3:[[PythagorasDMatrix3 alloc] init]];
}
...
- (PythagorasDMatrix3 *)lerpWithPythagorasDIMatrix3:(id<PythagorasDIMatrix3>)other
                                         withDouble:(double)t {
  return [self lerpWithPythagorasDIMatrix3:other withDouble:t withPythagorasDMatrix3:[[PythagorasDMatrix3 alloc] init]];
}
...
- (PythagorasDMatrix3 *)lerpAffineWithPythagorasDIMatrix3:(id<PythagorasDIMatrix3>)other
                                               withDouble:(double)t {
  return [self lerpAffineWithPythagorasDIMatrix3:other withDouble:t withPythagorasDMatrix3:[[PythagorasDMatrix3 alloc] init]];
}
...
- (JavaNioDoubleBuffer *)getWithJavaNioDoubleBuffer:(JavaNioDoubleBuffer *)buf {
  (void) [((JavaNioDoubleBuffer *) nil_chk([((JavaNioDoubleBuffer *) nil_chk([((JavaNioDoubleBuffer *) nil_chk(buf)) putWithDouble:m00__])) putWithDouble:m01__])) putWithDouble:m02__];
  (void) [((JavaNioDoubleBuffer *) nil_chk([((JavaNioDoubleBuffer *) nil_chk([((JavaNioDoubleBuffer *) nil_chk(buf)) putWithDouble:m10__])) putWithDouble:m11__])) putWithDouble:m12__];
  (void) [((JavaNioDoubleBuffer *) nil_chk([((JavaNioDoubleBuffer *) nil_chk([((JavaNioDoubleBuffer *) nil_chk(buf)) putWithDouble:m20__])) putWithDouble:m21__])) putWithDouble:m22__];
  return buf;
}
...
- (PythagorasDVector *)transformPointWithPythagorasDIVector:(id<PythagorasDIVector>)point {
  return [self transformPointWithPythagorasDIVector:point withPythagorasDVector:[[PythagorasDVector alloc] init]];
}
...
- (PythagorasDVector *)transformVectorWithPythagorasDIVector:(id<PythagorasDIVector>)vector {
  return [self transformVectorWithPythagorasDIVector:vector withPythagorasDVector:[[PythagorasDVector alloc] init]];
}
...
- (PythagorasDVector *)extractScale {
  return [self extractScaleWithPythagorasDVector:[[PythagorasDVector alloc] init]];
}
...
+ (void)initialize {
  if (self == [PythagorasDMatrix3 class]) {
    PythagorasDMatrix3_IDENTITY_ = [[PythagorasDMatrix3 alloc] init];
  }
}
