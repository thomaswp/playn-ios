...
#if !PythagorasDMatrix4_RESTRICT
#define PythagorasDMatrix4_INCLUDE_ALL 1
#endif
#undef PythagorasDMatrix4_RESTRICT

#if !defined (_PythagorasDMatrix4_) && (PythagorasDMatrix4_INCLUDE_ALL || PythagorasDMatrix4_INCLUDE)
#define _PythagorasDMatrix4_
...
#define PythagorasDIMatrix4_RESTRICT 1
#define PythagorasDIMatrix4_INCLUDE 1
