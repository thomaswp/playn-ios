...
+ (int)intersectLineAndQuadWithDouble:(double)x1
              ...
              withJavaLangDoubleArray:(IOSDoubleArray *)params {
  IOSDoubleArray *eqn = [[IOSDoubleArray alloc] initWithLength:3];
  IOSDoubleArray *t = [[IOSDoubleArray alloc] initWithLength:2];
  IOSDoubleArray *s = [[IOSDoubleArray alloc] initWithLength:2];
  double dy = y2 - y1;
  double dx = x2 - x1;
  int quantity = 0;
  int count = 0;
...
+ (int)intersectLineAndCubicWithDouble:(double)x1
               ...
               withJavaLangDoubleArray:(IOSDoubleArray *)params {
  IOSDoubleArray *eqn = [[IOSDoubleArray alloc] initWithLength:4];
  IOSDoubleArray *t = [[IOSDoubleArray alloc] initWithLength:3];
  IOSDoubleArray *s = [[IOSDoubleArray alloc] initWithLength:3];
  double dy = y2 - y1;
  double dx = x2 - x1;
  int quantity = 0;
  int count = 0;
...
+ (int)intersectQuadsWithDouble:(double)x1
                     ...
                     withDouble:(double)qy3
        withJavaLangDoubleArray:(IOSDoubleArray *)params {
  IOSDoubleArray *initParams = [[IOSDoubleArray alloc] initWithLength:2];
  IOSDoubleArray *xCoefs1 = [[IOSDoubleArray alloc] initWithLength:3];
  IOSDoubleArray *yCoefs1 = [[IOSDoubleArray alloc] initWithLength:3];
  IOSDoubleArray *xCoefs2 = [[IOSDoubleArray alloc] initWithLength:3];
  IOSDoubleArray *yCoefs2 = [[IOSDoubleArray alloc] initWithLength:3];
  int quantity = 0;
...
+ (int)intersectQuadAndCubicWithDouble:(double)qx1
               ...
               withJavaLangDoubleArray:(IOSDoubleArray *)params {
  int quantity = 0;
  IOSDoubleArray *initParams = [[IOSDoubleArray alloc] initWithLength:3];
  IOSDoubleArray *xCoefs1 = [[IOSDoubleArray alloc] initWithLength:3];
  IOSDoubleArray *yCoefs1 = [[IOSDoubleArray alloc] initWithLength:3];
  IOSDoubleArray *xCoefs2 = [[IOSDoubleArray alloc] initWithLength:4];
  IOSDoubleArray *yCoefs2 = [[IOSDoubleArray alloc] initWithLength:4];
...
+ (int)intersectCubicsWithDouble:(double)x1
  ...
  int quantity = 0;
  IOSDoubleArray *initParams = [[IOSDoubleArray alloc] initWithLength:3];
  IOSDoubleArray *xCoefs1 = [[IOSDoubleArray alloc] initWithLength:4];
  IOSDoubleArray *yCoefs1 = [[IOSDoubleArray alloc] initWithLength:4];
  IOSDoubleArray *xCoefs2 = [[IOSDoubleArray alloc] initWithLength:4];
  IOSDoubleArray *yCoefs2 = [[IOSDoubleArray alloc] initWithLength:4];
