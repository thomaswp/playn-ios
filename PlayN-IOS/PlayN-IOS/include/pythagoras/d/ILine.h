...
#if !PythagorasDILine_RESTRICT
#define PythagorasDILine_INCLUDE_ALL 1
#endif
#undef PythagorasDILine_RESTRICT

#if !defined (_PythagorasDILine_) && (PythagorasDILine_INCLUDE_ALL || PythagorasDILine_INCLUDE)
#define _PythagorasDILine_
...
@protocol PythagorasDILine < PythagorasDIShape, NSCopying, NSObject, JavaObject >
- (double)x1;
- (double)y1;
- (double)x2;
- (double)y2;
