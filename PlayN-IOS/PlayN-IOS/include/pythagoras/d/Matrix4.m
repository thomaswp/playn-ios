...
+ (void)initialize {
  if (self == [PythagorasDMatrix4 class]) {
    ...
    PythagorasDMatrix4_EMPTY_ARRAY_ = [[IOSObjectArray alloc] initWithLength:0 type:[IOSClass classWithClass:[PythagorasDMatrix4 class]]];
  }
}
