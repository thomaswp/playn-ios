...
#include "pythagoras/d/IMatrix3.h"
#include "pythagoras/d/IMatrix4.h"
#include "pythagoras/d/IPlane.h"
#include "pythagoras/d/IQuaternion.h"
...
#include "pythagoras/d/Matrix4.h"
#include "pythagoras/d/Quaternion.h"
#include "pythagoras/d/Vector3.h"
#include "pythagoras/d/Vector4.h"
...
- (PythagorasDMatrix4 *)setToRotationWithPythagorasDIVector3:(id<PythagorasDIVector3>)from
  ...
  if (angle <= JavaLangMath_PI - PythagorasDMathUtil_EPSILON) {
    return [self setToRotationWithDouble:angle withPythagorasDIVector3:[((PythagorasDVector3 *) nil_chk([((id<PythagorasDIVector3>) nil_chk(from)) crossWithPythagorasDIVector3:to])) normalizeLocal]];
  }
  ...
  return [self setToRotationWithDouble:JavaLangMath_PI withPythagorasDIVector3:length < PythagorasDMathUtil_EPSILON ? [((PythagorasDVector3 *) nil_chk([((PythagorasDVector3 *) nil_chk(axis)) setWithDouble:-[((id<PythagorasDIVector3>) nil_chk(from)) z] withDouble:0.0f withDouble:[((id<PythagorasDIVector3>) nil_chk(from)) x]])) normalizeLocal] : [((PythagorasDVector3 *) nil_chk(axis)) multLocalWithDouble:1.0f / length]];
}
...
- (PythagorasDMatrix4 *)setWithDoubleArray:(IOSDoubleArray *)values {
...
- (PythagorasDMatrix4 *)transpose {
  return [self transposeWithPythagorasDMatrix4:[[PythagorasDMatrix4 alloc] init]];
}
...
- (PythagorasDMatrix4 *)multWithPythagorasDIMatrix4:(id<PythagorasDIMatrix4>)other {
  return [self multWithPythagorasDIMatrix4:other withPythagorasDMatrix4:[[PythagorasDMatrix4 alloc] init]];
}
...
- (PythagorasDMatrix4 *)multAffineWithPythagorasDIMatrix4:(id<PythagorasDIMatrix4>)other {
  return [self multAffineWithPythagorasDIMatrix4:other withPythagorasDMatrix4:[[PythagorasDMatrix4 alloc] init]];
}
...
- (PythagorasDMatrix4 *)invert {
  return [self invertWithPythagorasDMatrix4:[[PythagorasDMatrix4 alloc] init]];
}
...
- (PythagorasDMatrix4 *)invertAffine {
  return [self invertAffineWithPythagorasDMatrix4:[[PythagorasDMatrix4 alloc] init]];
}
...
- (PythagorasDMatrix4 *)lerpWithPythagorasDIMatrix4:(id<PythagorasDIMatrix4>)other
                                         withDouble:(double)t {
  return [self lerpWithPythagorasDIMatrix4:other withDouble:t withPythagorasDMatrix4:[[PythagorasDMatrix4 alloc] init]];
}
...
- (PythagorasDMatrix4 *)lerpAffineWithPythagorasDIMatrix4:(id<PythagorasDIMatrix4>)other
                                               withDouble:(double)t {
  return [self lerpAffineWithPythagorasDIMatrix4:other withDouble:t withPythagorasDMatrix4:[[PythagorasDMatrix4 alloc] init]];
}
...
- (JavaNioDoubleBuffer *)getWithJavaNioDoubleBuffer:(JavaNioDoubleBuffer *)buf {
  (void) [((JavaNioDoubleBuffer *) nil_chk([((JavaNioDoubleBuffer *) nil_chk([((JavaNioDoubleBuffer *) nil_chk([((JavaNioDoubleBuffer *) nil_chk(buf)) putWithDouble:m00__])) putWithDouble:m01__])) putWithDouble:m02__])) putWithDouble:m03__];
  (void) [((JavaNioDoubleBuffer *) nil_chk([((JavaNioDoubleBuffer *) nil_chk([((JavaNioDoubleBuffer *) nil_chk([((JavaNioDoubleBuffer *) nil_chk(buf)) putWithDouble:m10__])) putWithDouble:m11__])) putWithDouble:m12__])) putWithDouble:m13__];
  (void) [((JavaNioDoubleBuffer *) nil_chk([((JavaNioDoubleBuffer *) nil_chk([((JavaNioDoubleBuffer *) nil_chk([((JavaNioDoubleBuffer *) nil_chk(buf)) putWithDouble:m20__])) putWithDouble:m21__])) putWithDouble:m22__])) putWithDouble:m23__];
  (void) [((JavaNioDoubleBuffer *) nil_chk([((JavaNioDoubleBuffer *) nil_chk([((JavaNioDoubleBuffer *) nil_chk([((JavaNioDoubleBuffer *) nil_chk(buf)) putWithDouble:m30__])) putWithDouble:m31__])) putWithDouble:m32__])) putWithDouble:m33__];
  return buf;
}
...
- (PythagorasDVector3 *)projectPointWithPythagorasDIVector3:(id<PythagorasDIVector3>)point {
  return [self projectPointWithPythagorasDIVector3:point withPythagorasDVector3:[[PythagorasDVector3 alloc] init]];
}
...
- (PythagorasDVector3 *)transformPointWithPythagorasDIVector3:(id<PythagorasDIVector3>)point {
  return [self transformPointWithPythagorasDIVector3:point withPythagorasDVector3:[[PythagorasDVector3 alloc] init]];
}
...
- (PythagorasDVector3 *)transformVectorWithPythagorasDIVector3:(id<PythagorasDIVector3>)vector {
  return [self transformVectorWithPythagorasDIVector3:vector withPythagorasDVector3:[[PythagorasDVector3 alloc] init]];
}
...
- (PythagorasDVector4 *)transformWithPythagorasDIVector4:(id<PythagorasDIVector4>)vector {
  return [self transformWithPythagorasDIVector4:vector withPythagorasDVector4:[[PythagorasDVector4 alloc] init]];
}
...
- (PythagorasDQuaternion *)extractRotation {
  return [self extractRotationWithPythagorasDQuaternion:[[PythagorasDQuaternion alloc] init]];
}
...
- (PythagorasDVector3 *)extractScale {
  return [self extractScaleWithPythagorasDVector3:[[PythagorasDVector3 alloc] init]];
}
...
+ (void)initialize {
  if (self == [PythagorasDMatrix4 class]) {
    PythagorasDMatrix4_IDENTITY_ = [[PythagorasDMatrix4 alloc] init];
    PythagorasDMatrix4_EMPTY_ARRAY_ = [IOSObjectArray arrayWithLength:0 type:[IOSClass classWithClass:[PythagorasDMatrix4 class]]];
  }
}
