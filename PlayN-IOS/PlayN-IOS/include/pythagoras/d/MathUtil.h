...
#if !PythagorasDMathUtil_RESTRICT
#define PythagorasDMathUtil_INCLUDE_ALL 1
#endif
#undef PythagorasDMathUtil_RESTRICT

#if !defined (_PythagorasDMathUtil_) && (PythagorasDMathUtil_INCLUDE_ALL || PythagorasDMathUtil_INCLUDE)
#define _PythagorasDMathUtil_
