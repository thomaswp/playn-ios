...
- (id<PythagorasDTransform>)concatenateWithPythagorasDTransform:(id<PythagorasDTransform>)other {
  ...
  if ([(id) other isKindOfClass:[PythagorasDAffineTransform class]]) {
    return ((PythagorasDAffineTransform *) [PythagorasDTransforms multiplyWithPythagorasDAffineTransform:self withPythagorasDAffineTransform:(PythagorasDAffineTransform *) other withId:[[PythagorasDAffineTransform alloc] init]]);
  }
  else {
...
- (id<PythagorasDTransform>)preConcatenateWithPythagorasDTransform:(id<PythagorasDTransform>)other {
  ...
  if ([(id) other isKindOfClass:[PythagorasDAffineTransform class]]) {
    return ((PythagorasDAffineTransform *) [PythagorasDTransforms multiplyWithPythagorasDAffineTransform:(PythagorasDAffineTransform *) other withPythagorasDAffineTransform:self withId:[[PythagorasDAffineTransform alloc] init]]);
  }
  else {
    PythagorasDAffineTransform *oaff = [[PythagorasDAffineTransform alloc] initWithPythagorasDTransform:other];
