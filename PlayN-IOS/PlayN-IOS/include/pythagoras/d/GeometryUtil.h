...
#if !PythagorasDGeometryUtil_RESTRICT
#define PythagorasDGeometryUtil_INCLUDE_ALL 1
#endif
#undef PythagorasDGeometryUtil_RESTRICT

#if !defined (_PythagorasDGeometryUtil_) && (PythagorasDGeometryUtil_INCLUDE_ALL || PythagorasDGeometryUtil_INCLUDE)
#define _PythagorasDGeometryUtil_
