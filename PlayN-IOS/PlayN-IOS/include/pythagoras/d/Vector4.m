...
- (JavaNioDoubleBuffer *)getWithJavaNioDoubleBuffer:(JavaNioDoubleBuffer *)buf {
  return [((JavaNioDoubleBuffer *) nil_chk([((JavaNioDoubleBuffer *) nil_chk([((JavaNioDoubleBuffer *) nil_chk([((JavaNioDoubleBuffer *) nil_chk(buf)) putWithDouble:x__])) putWithDouble:y__])) putWithDouble:z__])) putWithDouble:w__];
}
...
- (PythagorasDVector4 *)negate {
  return [self negateWithPythagorasDVector4:[[PythagorasDVector4 alloc] init]];
}
...
- (PythagorasDVector4 *)abs {
  return [self absWithPythagorasDVector4:[[PythagorasDVector4 alloc] init]];
}
...
- (PythagorasDVector4 *)multWithDouble:(double)v {
  return [self multWithDouble:v withPythagorasDVector4:[[PythagorasDVector4 alloc] init]];
}
...
- (PythagorasDVector4 *)multWithPythagorasDIMatrix4:(id<PythagorasDIMatrix4>)matrix {
  return [self multWithPythagorasDIMatrix4:matrix withPythagorasDVector4:[[PythagorasDVector4 alloc] init]];
}
