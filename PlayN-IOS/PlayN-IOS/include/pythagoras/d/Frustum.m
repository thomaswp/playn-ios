...
#include "pythagoras/d/Frustum.h"
#include "pythagoras/d/IVector3.h"
#include "pythagoras/d/Matrix3.h"
...
+ (void)set_vertex:(PythagorasDVector3 *)_vertex {
  PythagorasDFrustum__vertex_ = _vertex;
}

- (id)init {
  if ((self = [super init])) {
    _vertices_ = [IOSObjectArray arrayWithLength:8 type:[IOSClass classWithClass:[PythagorasDVector3 class]]];
    _planes_ = [IOSObjectArray arrayWithLength:6 type:[IOSClass classWithClass:[PythagorasDPlane class]]];
    _bounds_ = [[PythagorasDBox alloc] init];
    for (int ii = 0; ii < 8; ii++) {
      (void) [((IOSObjectArray *) nil_chk(_vertices_)) replaceObjectAtIndex:ii withObject:[[PythagorasDVector3 alloc] init]];
    }
    for (int ii = 0; ii < 6; ii++) {
      (void) [((IOSObjectArray *) nil_chk(_planes_)) replaceObjectAtIndex:ii withObject:[[PythagorasDPlane alloc] init]];
    }
  }
  return self;
}
...
- (PythagorasDFrustum *)setToProjectionWithDouble:(double)left
  ...
  if (ortho) {
    ...
    (void) [((PythagorasDVector3 *) nil_chk([((IOSObjectArray *) nil_chk(_vertices_)) objectAtIndex:0])) setWithDouble:left withDouble:bottom withDouble:xl + yb - near];
    (void) [((PythagorasDVector3 *) nil_chk([((IOSObjectArray *) nil_chk(_vertices_)) objectAtIndex:mirrored ? 3 : 1])) setWithDouble:right withDouble:bottom withDouble:xr + yb - near];
    (void) [((PythagorasDVector3 *) nil_chk([((IOSObjectArray *) nil_chk(_vertices_)) objectAtIndex:2])) setWithDouble:right withDouble:top withDouble:xr + yt - near];
    (void) [((PythagorasDVector3 *) nil_chk([((IOSObjectArray *) nil_chk(_vertices_)) objectAtIndex:mirrored ? 1 : 3])) setWithDouble:left withDouble:top withDouble:xl + yt - near];
    (void) [((PythagorasDVector3 *) nil_chk([((IOSObjectArray *) nil_chk(_vertices_)) objectAtIndex:4])) setWithDouble:left withDouble:bottom withDouble:xl + yb - far];
    (void) [((PythagorasDVector3 *) nil_chk([((IOSObjectArray *) nil_chk(_vertices_)) objectAtIndex:mirrored ? 7 : 5])) setWithDouble:right withDouble:bottom withDouble:xr + yb - far];
    (void) [((PythagorasDVector3 *) nil_chk([((IOSObjectArray *) nil_chk(_vertices_)) objectAtIndex:6])) setWithDouble:right withDouble:top withDouble:xr + yt - far];
    (void) [((PythagorasDVector3 *) nil_chk([((IOSObjectArray *) nil_chk(_vertices_)) objectAtIndex:mirrored ? 5 : 7])) setWithDouble:left withDouble:top withDouble:xl + yt - far];
  }
  else {
    double rn = 1.0f / near;
    ...
    (void) [((PythagorasDVector3 *) nil_chk([((IOSObjectArray *) nil_chk(_vertices_)) objectAtIndex:0])) setWithDouble:-z0 * lrn withDouble:-z0 * brn withDouble:z0];
    double z1 = nz / (nfnx * rrn + nfny * brn - nfnz);
    (void) [((PythagorasDVector3 *) nil_chk([((IOSObjectArray *) nil_chk(_vertices_)) objectAtIndex:mirrored ? 3 : 1])) setWithDouble:-z1 * rrn withDouble:-z1 * brn withDouble:z1];
    double z2 = nz / (nfnx * rrn + nfny * trn - nfnz);
    (void) [((PythagorasDVector3 *) nil_chk([((IOSObjectArray *) nil_chk(_vertices_)) objectAtIndex:2])) setWithDouble:-z2 * rrn withDouble:-z2 * trn withDouble:z2];
    double z3 = nz / (nfnx * lrn + nfny * trn - nfnz);
    (void) [((PythagorasDVector3 *) nil_chk([((IOSObjectArray *) nil_chk(_vertices_)) objectAtIndex:mirrored ? 1 : 3])) setWithDouble:-z3 * lrn withDouble:-z3 * trn withDouble:z3];
    double fz = far * nfnz;
    double z4 = fz / (nfnx * lrn + nfny * brn - nfnz);
    (void) [((PythagorasDVector3 *) nil_chk([((IOSObjectArray *) nil_chk(_vertices_)) objectAtIndex:4])) setWithDouble:-z4 * lrn withDouble:-z4 * brn withDouble:z4];
    double z5 = fz / (nfnx * rrn + nfny * brn - nfnz);
    (void) [((PythagorasDVector3 *) nil_chk([((IOSObjectArray *) nil_chk(_vertices_)) objectAtIndex:mirrored ? 7 : 5])) setWithDouble:-z5 * rrn withDouble:-z5 * brn withDouble:z5];
    double z6 = fz / (nfnx * rrn + nfny * trn - nfnz);
    (void) [((PythagorasDVector3 *) nil_chk([((IOSObjectArray *) nil_chk(_vertices_)) objectAtIndex:6])) setWithDouble:-z6 * rrn withDouble:-z6 * trn withDouble:z6];
    double z7 = fz / (nfnx * lrn + nfny * trn - nfnz);
    (void) [((PythagorasDVector3 *) nil_chk([((IOSObjectArray *) nil_chk(_vertices_)) objectAtIndex:mirrored ? 5 : 7])) setWithDouble:-z7 * lrn withDouble:-z7 * trn withDouble:z7];
  }
...
- (double)distanceWithPythagorasDVector3:(PythagorasDVector3 *)point {
  double distance = -JavaLangFloat_MAX_VALUE;
  {
    ...
    for (int i__ = 0; i__ < n__; i__++) {
      PythagorasDPlane *plane = [((IOSObjectArray *) nil_chk(a__)) objectAtIndex:i__];
...
- (PythagorasDFrustum_IntersectionTypeEnum *)intersectionTypeWithPythagorasDBox:(PythagorasDBox *)box {
  ...
  for (int ii = 0; ii < 6; ii++) {
    int inside = 0;
    PythagorasDPlane *plane = [((IOSObjectArray *) nil_chk(_planes_)) objectAtIndex:ii];
...
- (PythagorasDBox *)boundsUnderRotationWithPythagorasDMatrix3:(PythagorasDMatrix3 *)matrix
  ...
  (void) [((PythagorasDBox *) nil_chk(result)) setToEmpty];
  {
    ...
    int n__ = (int) [((IOSObjectArray *) nil_chk(a__)) count];
    for (int i__ = 0; i__ < n__; i__++) {
      PythagorasDVector3 *vertex = [((IOSObjectArray *) nil_chk(a__)) objectAtIndex:i__];
...
- (void)updateDerivedState {
  (void) [((PythagorasDPlane *) nil_chk([((IOSObjectArray *) nil_chk(_planes_)) objectAtIndex:0])) fromPointsWithPythagorasDIVector3:[((IOSObjectArray *) nil_chk(_vertices_)) objectAtIndex:0] withPythagorasDIVector3:[((IOSObjectArray *) nil_chk(_vertices_)) objectAtIndex:1] withPythagorasDIVector3:[((IOSObjectArray *) nil_chk(_vertices_)) objectAtIndex:2]];
  (void) [((PythagorasDPlane *) nil_chk([((IOSObjectArray *) nil_chk(_planes_)) objectAtIndex:1])) fromPointsWithPythagorasDIVector3:[((IOSObjectArray *) nil_chk(_vertices_)) objectAtIndex:5] withPythagorasDIVector3:[((IOSObjectArray *) nil_chk(_vertices_)) objectAtIndex:4] withPythagorasDIVector3:[((IOSObjectArray *) nil_chk(_vertices_)) objectAtIndex:7]];
  (void) [((PythagorasDPlane *) nil_chk([((IOSObjectArray *) nil_chk(_planes_)) objectAtIndex:2])) fromPointsWithPythagorasDIVector3:[((IOSObjectArray *) nil_chk(_vertices_)) objectAtIndex:1] withPythagorasDIVector3:[((IOSObjectArray *) nil_chk(_vertices_)) objectAtIndex:5] withPythagorasDIVector3:[((IOSObjectArray *) nil_chk(_vertices_)) objectAtIndex:6]];
  (void) [((PythagorasDPlane *) nil_chk([((IOSObjectArray *) nil_chk(_planes_)) objectAtIndex:3])) fromPointsWithPythagorasDIVector3:[((IOSObjectArray *) nil_chk(_vertices_)) objectAtIndex:4] withPythagorasDIVector3:[((IOSObjectArray *) nil_chk(_vertices_)) objectAtIndex:0] withPythagorasDIVector3:[((IOSObjectArray *) nil_chk(_vertices_)) objectAtIndex:3]];
  (void) [((PythagorasDPlane *) nil_chk([((IOSObjectArray *) nil_chk(_planes_)) objectAtIndex:4])) fromPointsWithPythagorasDIVector3:[((IOSObjectArray *) nil_chk(_vertices_)) objectAtIndex:3] withPythagorasDIVector3:[((IOSObjectArray *) nil_chk(_vertices_)) objectAtIndex:2] withPythagorasDIVector3:[((IOSObjectArray *) nil_chk(_vertices_)) objectAtIndex:6]];
  (void) [((PythagorasDPlane *) nil_chk([((IOSObjectArray *) nil_chk(_planes_)) objectAtIndex:5])) fromPointsWithPythagorasDIVector3:[((IOSObjectArray *) nil_chk(_vertices_)) objectAtIndex:4] withPythagorasDIVector3:[((IOSObjectArray *) nil_chk(_vertices_)) objectAtIndex:5] withPythagorasDIVector3:[((IOSObjectArray *) nil_chk(_vertices_)) objectAtIndex:1]];
  (void) [((PythagorasDBox *) nil_chk(_bounds_)) fromPointsWithPythagorasDIVector3Array:_vertices_];
}

+ (void)initialize {
  if (self == [PythagorasDFrustum class]) {
    PythagorasDFrustum__vertex_ = [[PythagorasDVector3 alloc] init];
  }
}
