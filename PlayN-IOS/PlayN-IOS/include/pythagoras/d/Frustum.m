...
- (id)init {
  if ((self = [super init])) {
    _vertices_ = [[IOSObjectArray alloc] initWithLength:8 type:[IOSClass classWithClass:[PythagorasDVector3 class]]];
    _planes_ = [[IOSObjectArray alloc] initWithLength:6 type:[IOSClass classWithClass:[PythagorasDPlane class]]];
    _bounds_ = [[PythagorasDBox alloc] init];
    for (int ii = 0; ii < 8; ii++) {
      [((IOSObjectArray *) NIL_CHK(_vertices_)) replaceObjectAtIndex:ii withObject:[[PythagorasDVector3 alloc] init]];
    }
    for (int ii = 0; ii < 6; ii++) {
      [((IOSObjectArray *) NIL_CHK(_planes_)) replaceObjectAtIndex:ii withObject:[[PythagorasDPlane alloc] init]];
    }
  }
  return self;
}
