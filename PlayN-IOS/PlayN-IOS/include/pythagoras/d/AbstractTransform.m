...
- (PythagorasDVector *)scale__ {
  return [[PythagorasDVector alloc] initWithDouble:[self scaleX] withDouble:[self scaleY]];
}

- (PythagorasDVector *)translation {
  return [[PythagorasDVector alloc] initWithDouble:[self tx] withDouble:[self ty]];
}
