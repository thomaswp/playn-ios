...
- (PythagorasDVector3 *)crossWithPythagorasDIVector3:(id<PythagorasDIVector3>)other {
  return [self crossWithPythagorasDIVector3:other withPythagorasDVector3:[[PythagorasDVector3 alloc] init]];
}
...
- (PythagorasDVector3 *)negate {
  return [self negateWithPythagorasDVector3:[[PythagorasDVector3 alloc] init]];
}
...
- (PythagorasDVector3 *)abs {
  return [self absWithPythagorasDVector3:[[PythagorasDVector3 alloc] init]];
}
...
- (PythagorasDVector3 *)normalize {
  return [self normalizeWithPythagorasDVector3:[[PythagorasDVector3 alloc] init]];
}
...
- (PythagorasDVector3 *)multWithDouble:(double)v {
  return [self multWithDouble:v withPythagorasDVector3:[[PythagorasDVector3 alloc] init]];
}
...
- (PythagorasDVector3 *)multWithPythagorasDIVector3:(id<PythagorasDIVector3>)other {
  return [self multWithPythagorasDIVector3:other withPythagorasDVector3:[[PythagorasDVector3 alloc] init]];
}
...
- (PythagorasDVector3 *)addWithPythagorasDIVector3:(id<PythagorasDIVector3>)other {
  return [self addWithPythagorasDIVector3:other withPythagorasDVector3:[[PythagorasDVector3 alloc] init]];
}
...
- (PythagorasDVector3 *)subtractWithPythagorasDIVector3:(id<PythagorasDIVector3>)other {
  return [self subtractWithPythagorasDIVector3:other withPythagorasDVector3:[[PythagorasDVector3 alloc] init]];
}
...
- (PythagorasDVector3 *)addWithDouble:(double)x
                           withDouble:(double)y
                           withDouble:(double)z {
  return [self addWithDouble:x withDouble:y withDouble:z withPythagorasDVector3:[[PythagorasDVector3 alloc] init]];
}
...
- (PythagorasDVector3 *)addScaledWithPythagorasDIVector3:(id<PythagorasDIVector3>)other
                                              withDouble:(double)v {
  return [self addScaledWithPythagorasDIVector3:other withDouble:v withPythagorasDVector3:[[PythagorasDVector3 alloc] init]];
}
...
- (PythagorasDVector3 *)lerpWithPythagorasDIVector3:(id<PythagorasDIVector3>)other
                                         withDouble:(double)t {
  return [self lerpWithPythagorasDIVector3:other withDouble:t withPythagorasDVector3:[[PythagorasDVector3 alloc] init]];
}
...
- (double)getWithInt:(int)idx {
  ...
  @throw [[JavaLangIndexOutOfBoundsException alloc] initWithNSString:[NSString valueOfInt:idx]];
}

- (void)getWithDoubleArray:(IOSDoubleArray *)values {
  (*[((IOSDoubleArray *) nil_chk(values)) doubleRefAtIndex:0]) = x__;
  (*[((IOSDoubleArray *) nil_chk(values)) doubleRefAtIndex:1]) = y__;
  (*[((IOSDoubleArray *) nil_chk(values)) doubleRefAtIndex:2]) = z__;
}

- (JavaNioDoubleBuffer *)getWithJavaNioDoubleBuffer:(JavaNioDoubleBuffer *)buf {
  return [((JavaNioDoubleBuffer *) nil_chk([((JavaNioDoubleBuffer *) nil_chk([((JavaNioDoubleBuffer *) nil_chk(buf)) putWithDouble:x__])) putWithDouble:y__])) putWithDouble:z__];
}
...
+ (void)initialize {
  if (self == [PythagorasDVector3 class]) {
    PythagorasDVector3_UNIT_X_ = [[PythagorasDVector3 alloc] initWithDouble:1.0f withDouble:0.0f withDouble:0.0f];
    PythagorasDVector3_UNIT_Y_ = [[PythagorasDVector3 alloc] initWithDouble:0.0f withDouble:1.0f withDouble:0.0f];
    PythagorasDVector3_UNIT_Z_ = [[PythagorasDVector3 alloc] initWithDouble:0.0f withDouble:0.0f withDouble:1.0f];
    PythagorasDVector3_UNIT_XYZ_ = [[PythagorasDVector3 alloc] initWithDouble:1.0f withDouble:1.0f withDouble:1.0f];
    PythagorasDVector3_NORMAL_XYZ_ = [((id<PythagorasDIVector3>) nil_chk(PythagorasDVector3_UNIT_XYZ_)) normalize];
    PythagorasDVector3_ZERO_ = [[PythagorasDVector3 alloc] initWithDouble:0.0f withDouble:0.0f withDouble:0.0f];
    PythagorasDVector3_MIN_VALUE_ = [[PythagorasDVector3 alloc] initWithDouble:-JavaLangFloat_MAX_VALUE withDouble:-JavaLangFloat_MAX_VALUE withDouble:-JavaLangFloat_MAX_VALUE];
    PythagorasDVector3_MAX_VALUE_ = [[PythagorasDVector3 alloc] initWithDouble:JavaLangFloat_MAX_VALUE withDouble:JavaLangFloat_MAX_VALUE withDouble:JavaLangFloat_MAX_VALUE];
  }
}
