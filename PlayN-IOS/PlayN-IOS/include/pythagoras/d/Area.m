...
#import "pythagoras/d/Area.h"
#import "pythagoras/d/Crossing.h"
#import "pythagoras/d/CrossingHelper.h"
#import "pythagoras/d/CurveCrossingHelper.h"
...
- (id)init {
  if ((self = [super init])) {
    coords_ = [[IOSDoubleArray alloc] initWithLength:20];
    coordsSize_ = 0;
...
- (id)initWithPythagorasDIShape:(id<PythagorasDIShape>)s {
  if ((self = [super init])) {
    ...
    moveToCount_ = 0;
    isPolygonal__ = YES;
    IOSDoubleArray *segmentCoords = [[IOSDoubleArray alloc] initWithLength:6];
    ...
    for (id<PythagorasDPathIterator> pi = [((id<PythagorasDIShape>) NIL_CHK(s)) pathIteratorWithPythagorasDTransform:nil]; ![((id<PythagorasDPathIterator>) NIL_CHK(pi)) isDone]; [((id<PythagorasDPathIterator>) NIL_CHK(pi)) next]) {
      coords_ = [PythagorasDArea adjustSizeWithJavaLangDoubleArray:coords_ withInt:coordsIndex + 6];
      rules_ = [PythagorasDArea adjustSizeWithJavaLangIntegerArray:rules_ withInt:rulesIndex + 1];
      offsets_ = [PythagorasDArea adjustSizeWithJavaLangIntegerArray:offsets_ withInt:rulesIndex + 1];
...
- (void)addCurvePolygonWithPythagorasDArea:(PythagorasDArea *)area {
  ...
  if ((int) [((IOSObjectArray *) NIL_CHK(intersectPoints)) count] == 0) {
    if ([((PythagorasDArea *) NIL_CHK(area)) containsWithPythagorasDIRectangle:[self bounds]]) {
      ...
      coords_ = [PythagorasDArea adjustSizeWithJavaLangDoubleArray:coords_ withInt:coordsSize_ + ((PythagorasDArea *) NIL_CHK(area)).coordsSize];
      ...
      rules_ = [PythagorasDArea adjustSizeWithJavaLangIntegerArray:rules_ withInt:rulesSize_ + ((PythagorasDArea *) NIL_CHK(area)).rulesSize];
      ...
      offsets_ = [PythagorasDArea adjustSizeWithJavaLangIntegerArray:offsets_ withInt:rulesSize_ + ((PythagorasDArea *) NIL_CHK(area)).rulesSize];
  ...
  IOSDoubleArray *resultCoords = [[IOSDoubleArray alloc] initWithLength:coordsSize_ + ((PythagorasDArea *) NIL_CHK(area)).coordsSize + (int) [((IOSObjectArray *) NIL_CHK(intersectPoints)) count]];
  IOSIntArray *resultRules = [[IOSIntArray alloc] initWithLength:rulesSize_ + ((PythagorasDArea *) NIL_CHK(area)).rulesSize + (int) [((IOSObjectArray *) NIL_CHK(intersectPoints)) count]];
  IOSIntArray *resultOffsets = [[IOSIntArray alloc] initWithLength:rulesSize_ + ((PythagorasDArea *) NIL_CHK(area)).rulesSize + (int) [((IOSObjectArray *) NIL_CHK(intersectPoints)) count]];
...
- (void)addPolygonWithPythagorasDArea:(PythagorasDArea *)area {
  PythagorasDCrossingHelper *crossHelper = [[PythagorasDCrossingHelper alloc] initWithJavaLangDoubleArray:[IOSObjectArray arrayWithObjects:(id[]){ coords_, ((PythagorasDArea *) NIL_CHK(area)).coords } count:2 type:[IOSClass classWithClass:[IOSDoubleArray class]]] withJavaLangIntegerArray:[IOSIntArray arrayWithInts:(int[]){ coordsSize_, ((PythagorasDArea *) NIL_CHK(area)).coordsSize } count:2]];
...
- (void)subtractPolygonWithPythagorasDArea:(PythagorasDArea *)area {
  ...
  IOSDoubleArray *resultCoords = [[IOSDoubleArray alloc] initWithLength:2 * (coordsSize_ + ((PythagorasDArea *) NIL_CHK(area)).coordsSize + (int) [((IOSObjectArray *) NIL_CHK(intersectPoints)) count])];
  IOSIntArray *resultRules = [[IOSIntArray alloc] initWithLength:2 * (rulesSize_ + ((PythagorasDArea *) NIL_CHK(area)).rulesSize + (int) [((IOSObjectArray *) NIL_CHK(intersectPoints)) count])];
  IOSIntArray *resultOffsets = [[IOSIntArray alloc] initWithLength:2 * (rulesSize_ + ((PythagorasDArea *) NIL_CHK(area)).rulesSize + (int) [((IOSObjectArray *) NIL_CHK(intersectPoints)) count])];
  int resultCoordPos = 0;
  int resultRulesPos = 0;
  BOOL isCurrentArea = YES;
  int countPoints = 0;
  ...
  do {
    ...
    if ((offset > 0) && (((isCurrentArea) && ([((PythagorasDIntersectPoint *) NIL_CHK(nextPoint)) begIndexWithBOOL:isCurrentArea] < [((PythagorasDIntersectPoint *) NIL_CHK(point)) endIndexWithBOOL:isCurrentArea])) || ((!isCurrentArea) && ([((PythagorasDIntersectPoint *) NIL_CHK(nextPoint)) endIndexWithBOOL:isCurrentArea] < [((PythagorasDIntersectPoint *) NIL_CHK(nextPoint)) begIndexWithBOOL:isCurrentArea])))) {
      ...
      if (isCurrentArea) {
        ...
        IOSDoubleArray *temp = [[IOSDoubleArray alloc] initWithLength:length];
...
- (int)includeCoordsAndRulesWithInt:(int)offset
  ...
  IOSDoubleArray *temp = [[IOSDoubleArray alloc] initWithLength:8 * length];
  int coordsCount = 0;
...
- (int)containsExactWithDouble:(double)x
  ...
  IOSDoubleArray *segmentCoords = [[IOSDoubleArray alloc] initWithLength:6];
  IOSDoubleArray *resultPoints = [[IOSDoubleArray alloc] initWithLength:6];
  int rule;
  double curX = -1;
  double curY = -1;
  double moveX = -1;
...
- (void)reverseCopyWithJavaLangDoubleArray:(IOSDoubleArray *)coords {
  IOSDoubleArray *temp = [[IOSDoubleArray alloc] initWithLength:(int) [((IOSDoubleArray *) NIL_CHK(coords)) count]];
...
+ (IOSDoubleArray *)adjustSizeWithJavaLangDoubleArray:(IOSDoubleArray *)array
  ...
  IOSDoubleArray *newArray = [[IOSDoubleArray alloc] initWithLength:2 * newSize];
