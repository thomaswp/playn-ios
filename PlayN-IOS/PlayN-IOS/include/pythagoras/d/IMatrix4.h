...
#if !PythagorasDIMatrix4_RESTRICT
#define PythagorasDIMatrix4_INCLUDE_ALL 1
#endif
#undef PythagorasDIMatrix4_RESTRICT

#if !defined (_PythagorasDIMatrix4_) && (PythagorasDIMatrix4_INCLUDE_ALL || PythagorasDIMatrix4_INCLUDE)
#define _PythagorasDIMatrix4_
...
@protocol PythagorasDIMatrix4 < NSObject, JavaObject >
- (double)m00;
- (double)m10;
- (double)m20;
- (double)m30;
