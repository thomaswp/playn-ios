...
+ (int)crossQuadWithDouble:(double)x1
  ...
  IOSDoubleArray *res = [[IOSDoubleArray alloc] initWithLength:3];
...
+ (int)crossPathWithPythagorasDPathIterator:(id<PythagorasDPathIterator>)p
  ...
  double mx, my, cx, cy;
  mx = my = cx = cy = 0.0f;
  IOSDoubleArray *coords = [[IOSDoubleArray alloc] initWithLength:6];
...
+ (int)intersectQuadWithDouble:(double)x1
  ...
  double px2 = rx2 - x1;
  double py2 = ry2 - y1;
  IOSDoubleArray *res1 = [[IOSDoubleArray alloc] initWithLength:3];
  IOSDoubleArray *res2 = [[IOSDoubleArray alloc] initWithLength:3];
  ...
  IOSDoubleArray *bound = [[IOSDoubleArray alloc] initWithLength:28];
  int bc = 0;
...
+ (int)intersectCubicWithDouble:(double)x1
  ...
  double minX = px1 - PythagorasDCrossing_DELTA;
  double maxX = px2 + PythagorasDCrossing_DELTA;
  IOSDoubleArray *bound = [[IOSDoubleArray alloc] initWithLength:40];
  int bc = 0;
