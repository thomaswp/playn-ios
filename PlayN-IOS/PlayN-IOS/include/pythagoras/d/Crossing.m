...
+ (int)solveQuadWithDoubleArray:(IOSDoubleArray *)eqn
  ...
  if (a == 0.0f) {
    ...
    (*[((IOSDoubleArray *) nil_chk(res)) doubleRefAtIndex:rc++]) = -c / b;
  }
  else {
    ...
    (*[((IOSDoubleArray *) nil_chk(res)) doubleRefAtIndex:rc++]) = (-b + d) / (a * 2.0f);
    if (d != 0.0f) {
      (*[((IOSDoubleArray *) nil_chk(res)) doubleRefAtIndex:rc++]) = (-b - d) / (a * 2.0f);
    }
  }
  return [PythagorasDCrossing fixRootsWithDoubleArray:res withInt:rc];
}
...
+ (int)solveCubicWithDoubleArray:(IOSDoubleArray *)eqn
  ...
  if (R2 < Q3) {
    ...
    (*[((IOSDoubleArray *) nil_chk(res)) doubleRefAtIndex:rc++]) = m * [JavaLangMath cosWithDouble:t] + n;
    (*[((IOSDoubleArray *) nil_chk(res)) doubleRefAtIndex:rc++]) = m * [JavaLangMath cosWithDouble:t + p] + n;
    (*[((IOSDoubleArray *) nil_chk(res)) doubleRefAtIndex:rc++]) = m * [JavaLangMath cosWithDouble:t - p] + n;
  }
  else {
    ...
    if (-PythagorasDCrossing_ROOT_DELTA < A && A < PythagorasDCrossing_ROOT_DELTA) {
      (*[((IOSDoubleArray *) nil_chk(res)) doubleRefAtIndex:rc++]) = n;
    }
    else {
      double B = Q / A;
      (*[((IOSDoubleArray *) nil_chk(res)) doubleRefAtIndex:rc++]) = A + B + n;
      double delta = R2 - Q3;
      if (-PythagorasDCrossing_ROOT_DELTA < delta && delta < PythagorasDCrossing_ROOT_DELTA) {
        (*[((IOSDoubleArray *) nil_chk(res)) doubleRefAtIndex:rc++]) = -(A + B) / 2.0f + n;
      }
    }
  }
  return [PythagorasDCrossing fixRootsWithDoubleArray:res withInt:rc];
...
+ (int)fixRootsWithDoubleArray:(IOSDoubleArray *)res
  ...
  for (int i = 0; i < rc; i++) {
    out: {
      ...
      (*[((IOSDoubleArray *) nil_chk(res)) doubleRefAtIndex:tc++]) = [((IOSDoubleArray *) nil_chk(res)) doubleAtIndex:i];
    }
  }
  return tc;
}
...
+ (int)crossQuadWithDouble:(double)x1
  ...
  PythagorasDCrossing_QuadCurve *c = [[PythagorasDCrossing_QuadCurve alloc] initWithDouble:x1 withDouble:y1 withDouble:cx withDouble:cy withDouble:x2 withDouble:y2];
  double px = x - x1, py = y - y1;
  IOSDoubleArray *res = [IOSDoubleArray arrayWithLength:3];
  int rc = [((PythagorasDCrossing_QuadCurve *) nil_chk(c)) solvePointWithDoubleArray:res withDouble:px];
  return [((PythagorasDCrossing_QuadCurve *) nil_chk(c)) crossWithDoubleArray:res withInt:rc withDouble:py withDouble:py];
}
...
+ (int)crossCubicWithDouble:(double)x1
  ...
  PythagorasDCrossing_CubicCurveH *c = [[PythagorasDCrossing_CubicCurveH alloc] initWithDouble:x1 withDouble:y1 withDouble:cx1 withDouble:cy1 withDouble:cx2 withDouble:cy2 withDouble:x2 withDouble:y2];
  double px = x - x1, py = y - y1;
  IOSDoubleArray *res = [IOSDoubleArray arrayWithLength:3];
  int rc = [((PythagorasDCrossing_CubicCurveH *) nil_chk(c)) solvePointWithDoubleArray:res withDouble:px];
  return [((PythagorasDCrossing_CubicCurveH *) nil_chk(c)) crossWithDoubleArray:res withInt:rc withDouble:py withDouble:py];
}
...
+ (int)crossPathWithPythagorasDPathIterator:(id<PythagorasDPathIterator>)p
  ...
  while (![((id<PythagorasDPathIterator>) nil_chk(p)) isDone]) {
    switch ([((id<PythagorasDPathIterator>) nil_chk(p)) currentSegmentWithDoubleArray:coords]) {
...
+ (int)crossShapeWithPythagorasDIShape:(id<PythagorasDIShape>)s
                            withDouble:(double)x
                            withDouble:(double)y {
  if (![((PythagorasDRectangle *) nil_chk([((id<PythagorasDIShape>) nil_chk(s)) bounds])) containsWithDouble:x withDouble:y]) {
    return 0;
  }
...
+ (int)intersectQuadWithDouble:(double)x1
  ...
  int rc1 = [((PythagorasDCrossing_QuadCurve *) nil_chk(c)) solvePointWithDoubleArray:res1 withDouble:px1];
  int rc2 = [((PythagorasDCrossing_QuadCurve *) nil_chk(c)) solvePointWithDoubleArray:res2 withDouble:px2];
  if (rc1 == 0 && rc2 == 0) {
    return 0;
  }
  ...
  int bc = 0;
  bc = [((PythagorasDCrossing_QuadCurve *) nil_chk(c)) addBoundWithDoubleArray:bound withInt:bc withDoubleArray:res1 withInt:rc1 withDouble:minX withDouble:maxX withBOOL:NO withInt:0];
  bc = [((PythagorasDCrossing_QuadCurve *) nil_chk(c)) addBoundWithDoubleArray:bound withInt:bc withDoubleArray:res2 withInt:rc2 withDouble:minX withDouble:maxX withBOOL:NO withInt:1];
  rc2 = [((PythagorasDCrossing_QuadCurve *) nil_chk(c)) solveExtremeWithDoubleArray:res2];
  bc = [((PythagorasDCrossing_QuadCurve *) nil_chk(c)) addBoundWithDoubleArray:bound withInt:bc withDoubleArray:res2 withInt:rc2 withDouble:minX withDouble:maxX withBOOL:YES withInt:2];
  if (rx1 < x1 && x1 < rx2) {
    (*[((IOSDoubleArray *) nil_chk(bound)) doubleRefAtIndex:bc++]) = 0.0f;
    (*[((IOSDoubleArray *) nil_chk(bound)) doubleRefAtIndex:bc++]) = 0.0f;
    (*[((IOSDoubleArray *) nil_chk(bound)) doubleRefAtIndex:bc++]) = 0.0f;
    (*[((IOSDoubleArray *) nil_chk(bound)) doubleRefAtIndex:bc++]) = 4;
  }
  if (rx1 < x2 && x2 < rx2) {
    (*[((IOSDoubleArray *) nil_chk(bound)) doubleRefAtIndex:bc++]) = 1.0f;
    (*[((IOSDoubleArray *) nil_chk(bound)) doubleRefAtIndex:bc++]) = ((PythagorasDCrossing_QuadCurve *) nil_chk(c)).ax;
    (*[((IOSDoubleArray *) nil_chk(bound)) doubleRefAtIndex:bc++]) = ((PythagorasDCrossing_QuadCurve *) nil_chk(c)).ay;
    (*[((IOSDoubleArray *) nil_chk(bound)) doubleRefAtIndex:bc++]) = 5;
  }
  int cross = [PythagorasDCrossing crossBoundWithDoubleArray:bound withInt:bc withDouble:py1 withDouble:py2];
  if (cross != PythagorasDCrossing_UNKNOWN) {
    return cross;
  }
  return [((PythagorasDCrossing_QuadCurve *) nil_chk(c)) crossWithDoubleArray:res1 withInt:rc1 withDouble:py1 withDouble:py2];
}
...
+ (int)intersectCubicWithDouble:(double)x1
  ...
  IOSDoubleArray *res1 = [IOSDoubleArray arrayWithLength:3];
  IOSDoubleArray *res2 = [IOSDoubleArray arrayWithLength:3];
  int rc1 = [((PythagorasDCrossing_CubicCurveH *) nil_chk(c)) solvePointWithDoubleArray:res1 withDouble:px1];
  int rc2 = [((PythagorasDCrossing_CubicCurveH *) nil_chk(c)) solvePointWithDoubleArray:res2 withDouble:px2];
  if (rc1 == 0 && rc2 == 0) {
    return 0;
  }
  double minX = px1 - PythagorasDCrossing_DELTA;
  ...
  int bc = 0;
  bc = [((PythagorasDCrossing_CubicCurveH *) nil_chk(c)) addBoundWithDoubleArray:bound withInt:bc withDoubleArray:res1 withInt:rc1 withDouble:minX withDouble:maxX withBOOL:NO withInt:0];
  bc = [((PythagorasDCrossing_CubicCurveH *) nil_chk(c)) addBoundWithDoubleArray:bound withInt:bc withDoubleArray:res2 withInt:rc2 withDouble:minX withDouble:maxX withBOOL:NO withInt:1];
  rc2 = [((PythagorasDCrossing_CubicCurveH *) nil_chk(c)) solveExtremeXWithDoubleArray:res2];
  bc = [((PythagorasDCrossing_CubicCurveH *) nil_chk(c)) addBoundWithDoubleArray:bound withInt:bc withDoubleArray:res2 withInt:rc2 withDouble:minX withDouble:maxX withBOOL:YES withInt:2];
  rc2 = [((PythagorasDCrossing_CubicCurveH *) nil_chk(c)) solveExtremeYWithDoubleArray:res2];
  bc = [((PythagorasDCrossing_CubicCurveH *) nil_chk(c)) addBoundWithDoubleArray:bound withInt:bc withDoubleArray:res2 withInt:rc2 withDouble:minX withDouble:maxX withBOOL:YES withInt:4];
  if (rx1 < x1 && x1 < rx2) {
    (*[((IOSDoubleArray *) nil_chk(bound)) doubleRefAtIndex:bc++]) = 0.0f;
    (*[((IOSDoubleArray *) nil_chk(bound)) doubleRefAtIndex:bc++]) = 0.0f;
    (*[((IOSDoubleArray *) nil_chk(bound)) doubleRefAtIndex:bc++]) = 0.0f;
    (*[((IOSDoubleArray *) nil_chk(bound)) doubleRefAtIndex:bc++]) = 6;
  }
  if (rx1 < x2 && x2 < rx2) {
    (*[((IOSDoubleArray *) nil_chk(bound)) doubleRefAtIndex:bc++]) = 1.0f;
    (*[((IOSDoubleArray *) nil_chk(bound)) doubleRefAtIndex:bc++]) = ((PythagorasDCrossing_CubicCurveH *) nil_chk(c)).ax;
    (*[((IOSDoubleArray *) nil_chk(bound)) doubleRefAtIndex:bc++]) = ((PythagorasDCrossing_CubicCurveH *) nil_chk(c)).ay;
    (*[((IOSDoubleArray *) nil_chk(bound)) doubleRefAtIndex:bc++]) = 7;
  }
  int cross = [PythagorasDCrossing crossBoundWithDoubleArray:bound withInt:bc withDouble:py1 withDouble:py2];
  if (cross != PythagorasDCrossing_UNKNOWN) {
    return cross;
  }
  return [((PythagorasDCrossing_CubicCurveH *) nil_chk(c)) crossWithDoubleArray:res1 withInt:rc1 withDouble:py1 withDouble:py2];
}
...
+ (int)intersectShapeWithPythagorasDIShape:(id<PythagorasDIShape>)s
                                ...
                                withDouble:(double)w
                                withDouble:(double)h {
  if (![((PythagorasDRectangle *) nil_chk([((id<PythagorasDIShape>) nil_chk(s)) bounds])) intersectsWithDouble:x withDouble:y withDouble:w withDouble:h]) {
    return 0;
  }
...
+ (void)sortBoundWithDoubleArray:(IOSDoubleArray *)bound
  ...
  for (int i = 0; i < bc - 4; i += 4) {
    ...
    if (k != i) {
      ...
      (*[((IOSDoubleArray *) nil_chk(bound)) doubleRefAtIndex:i]) = [((IOSDoubleArray *) nil_chk(bound)) doubleAtIndex:k];
      (*[((IOSDoubleArray *) nil_chk(bound)) doubleRefAtIndex:k]) = tmp;
      tmp = [((IOSDoubleArray *) nil_chk(bound)) doubleAtIndex:i + 1];
      (*[((IOSDoubleArray *) nil_chk(bound)) doubleRefAtIndex:i + 1]) = [((IOSDoubleArray *) nil_chk(bound)) doubleAtIndex:k + 1];
      (*[((IOSDoubleArray *) nil_chk(bound)) doubleRefAtIndex:k + 1]) = tmp;
      tmp = [((IOSDoubleArray *) nil_chk(bound)) doubleAtIndex:i + 2];
      (*[((IOSDoubleArray *) nil_chk(bound)) doubleRefAtIndex:i + 2]) = [((IOSDoubleArray *) nil_chk(bound)) doubleAtIndex:k + 2];
      (*[((IOSDoubleArray *) nil_chk(bound)) doubleRefAtIndex:k + 2]) = tmp;
      tmp = [((IOSDoubleArray *) nil_chk(bound)) doubleAtIndex:i + 3];
      (*[((IOSDoubleArray *) nil_chk(bound)) doubleRefAtIndex:i + 3]) = [((IOSDoubleArray *) nil_chk(bound)) doubleAtIndex:k + 3];
      (*[((IOSDoubleArray *) nil_chk(bound)) doubleRefAtIndex:k + 3]) = tmp;
    }
  }
}
...
+ (int)crossBoundWithDoubleArray:(IOSDoubleArray *)bound
  ...
  if (up != 0) {
    [PythagorasDCrossing sortBoundWithDoubleArray:bound withInt:bc];
...
- (int)solveExtremeWithDoubleArray:(IOSDoubleArray *)res {
  int rc = 0;
  if (Ax_ != 0.0f) {
    (*[((IOSDoubleArray *) nil_chk(res)) doubleRefAtIndex:rc++]) = -Bx_ / (Ax_ + Ax_);
  }
  if (Ay_ != 0.0f) {
    (*[((IOSDoubleArray *) nil_chk(res)) doubleRefAtIndex:rc++]) = -By_ / (Ay_ + Ay_);
  }
  return rc;
}
...
- (int)addBoundWithDoubleArray:(IOSDoubleArray *)bound
  ...
  for (int i = 0; i < rc; i++) {
    ...
    if (t > -PythagorasDCrossing_DELTA && t < 1 + PythagorasDCrossing_DELTA) {
      ...
      if (minX <= rx && rx <= maxX) {
        (*[((IOSDoubleArray *) nil_chk(bound)) doubleRefAtIndex:bc++]) = t;
        (*[((IOSDoubleArray *) nil_chk(bound)) doubleRefAtIndex:bc++]) = rx;
        (*[((IOSDoubleArray *) nil_chk(bound)) doubleRefAtIndex:bc++]) = t * (t * Ay_ + By_);
        (*[((IOSDoubleArray *) nil_chk(bound)) doubleRefAtIndex:bc++]) = id_;
        if (changeId) {
          id_++;
        }
      }
  ...
  for (int i = 0; i < rc; i++) {
    ...
    if (t > -PythagorasDCrossing_DELTA && t < 1 + PythagorasDCrossing_DELTA) {
      ...
      if (minX <= rx && rx <= maxX) {
        (*[((IOSDoubleArray *) nil_chk(bound)) doubleRefAtIndex:bc++]) = t;
        (*[((IOSDoubleArray *) nil_chk(bound)) doubleRefAtIndex:bc++]) = rx;
        (*[((IOSDoubleArray *) nil_chk(bound)) doubleRefAtIndex:bc++]) = t * (t * (t * Ay_ + By_) + Cy_);
        (*[((IOSDoubleArray *) nil_chk(bound)) doubleRefAtIndex:bc++]) = id_;
        if (changeId) {
          id_++;
        }
