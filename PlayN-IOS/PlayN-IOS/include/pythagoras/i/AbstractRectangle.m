...
- (PythagorasIPoint *)location {
  return [self locationWithPythagorasIPoint:[[PythagorasIPoint alloc] init]];
}
...
- (PythagorasIDimension *)size {
  return [self sizeWithPythagorasIDimension:[[PythagorasIDimension alloc] init]];
}
...
- (PythagorasIRectangle *)intersectionWithInt:(int)rx
  ...
  return [[PythagorasIRectangle alloc] initWithInt:x1 withInt:y1 withInt:x2 - x1 withInt:y2 - y1];
}
...
- (PythagorasIRectangle *)union__WithPythagorasIIRectangle:(id<PythagorasIIRectangle>)r {
  PythagorasIRectangle *rect = [[PythagorasIRectangle alloc] initWithPythagorasIIRectangle:self];
...
- (PythagorasIRectangle *)clone {
  return [[PythagorasIRectangle alloc] initWithPythagorasIIRectangle:self];
}
...
- (PythagorasIRectangle *)bounds {
  return [self boundsWithPythagorasIRectangle:[[PythagorasIRectangle alloc] init]];
}
