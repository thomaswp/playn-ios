...
#if !PythagorasFQuadCurve_RESTRICT
#define PythagorasFQuadCurve_INCLUDE_ALL 1
#endif
#undef PythagorasFQuadCurve_RESTRICT

#if !defined (_PythagorasFQuadCurve_) && (PythagorasFQuadCurve_INCLUDE_ALL || PythagorasFQuadCurve_INCLUDE)
#define _PythagorasFQuadCurve_
...
#define PythagorasFAbstractQuadCurve_RESTRICT 1
#define PythagorasFAbstractQuadCurve_INCLUDE 1
