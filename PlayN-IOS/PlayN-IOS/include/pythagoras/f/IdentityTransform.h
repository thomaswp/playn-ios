...
#if !PythagorasFIdentityTransform_RESTRICT
#define PythagorasFIdentityTransform_INCLUDE_ALL 1
#endif
#undef PythagorasFIdentityTransform_RESTRICT

#if !defined (_PythagorasFIdentityTransform_) && (PythagorasFIdentityTransform_INCLUDE_ALL || PythagorasFIdentityTransform_INCLUDE)
#define _PythagorasFIdentityTransform_
...
#define PythagorasFAbstractTransform_RESTRICT 1
#define PythagorasFAbstractTransform_INCLUDE 1
