...
#if !PythagorasFBox_RESTRICT
#define PythagorasFBox_INCLUDE_ALL 1
#endif
#undef PythagorasFBox_RESTRICT

#if !defined (_PythagorasFBox_) && (PythagorasFBox_INCLUDE_ALL || PythagorasFBox_INCLUDE)
#define _PythagorasFBox_
...
#define PythagorasFIBox_RESTRICT 1
#define PythagorasFIBox_INCLUDE 1
...
@property (nonatomic, strong) PythagorasFVector3 *_minExtent;
@property (nonatomic, strong) PythagorasFVector3 *_maxExtent;
