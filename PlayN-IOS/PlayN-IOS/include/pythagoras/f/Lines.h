...
#if !PythagorasFLines_RESTRICT
#define PythagorasFLines_INCLUDE_ALL 1
#endif
#undef PythagorasFLines_RESTRICT

#if !defined (_PythagorasFLines_) && (PythagorasFLines_INCLUDE_ALL || PythagorasFLines_INCLUDE)
#define _PythagorasFLines_
