...
+ (int)intersectLineAndQuadWithFloat:(float)x1
                           ...
                           withFloat:(float)qy3
              withJavaLangFloatArray:(IOSFloatArray *)params {
  IOSFloatArray *eqn = [[IOSFloatArray alloc] initWithLength:3];
  IOSFloatArray *t = [[IOSFloatArray alloc] initWithLength:2];
  IOSFloatArray *s = [[IOSFloatArray alloc] initWithLength:2];
  float dy = y2 - y1;
  float dx = x2 - x1;
  int quantity = 0;
  int count = 0;
...
+ (int)intersectLineAndCubicWithFloat:(float)x1
                            ...
                            withFloat:(float)cy4
               withJavaLangFloatArray:(IOSFloatArray *)params {
  IOSFloatArray *eqn = [[IOSFloatArray alloc] initWithLength:4];
  IOSFloatArray *t = [[IOSFloatArray alloc] initWithLength:3];
  IOSFloatArray *s = [[IOSFloatArray alloc] initWithLength:3];
  float dy = y2 - y1;
  float dx = x2 - x1;
  int quantity = 0;
  int count = 0;
...
+ (int)intersectQuadsWithFloat:(float)x1
                     ...
                     withFloat:(float)qy3
        withJavaLangFloatArray:(IOSFloatArray *)params {
  IOSFloatArray *initParams = [[IOSFloatArray alloc] initWithLength:2];
  IOSFloatArray *xCoefs1 = [[IOSFloatArray alloc] initWithLength:3];
  IOSFloatArray *yCoefs1 = [[IOSFloatArray alloc] initWithLength:3];
  IOSFloatArray *xCoefs2 = [[IOSFloatArray alloc] initWithLength:3];
  IOSFloatArray *yCoefs2 = [[IOSFloatArray alloc] initWithLength:3];
  int quantity = 0;
...
+ (int)intersectQuadAndCubicWithFloat:(float)qx1
               ...
               withJavaLangFloatArray:(IOSFloatArray *)params {
  int quantity = 0;
  IOSFloatArray *initParams = [[IOSFloatArray alloc] initWithLength:3];
  IOSFloatArray *xCoefs1 = [[IOSFloatArray alloc] initWithLength:3];
  IOSFloatArray *yCoefs1 = [[IOSFloatArray alloc] initWithLength:3];
  IOSFloatArray *xCoefs2 = [[IOSFloatArray alloc] initWithLength:4];
  IOSFloatArray *yCoefs2 = [[IOSFloatArray alloc] initWithLength:4];
...
+ (int)intersectCubicsWithFloat:(float)x1
  ...
  int quantity = 0;
  IOSFloatArray *initParams = [[IOSFloatArray alloc] initWithLength:3];
  IOSFloatArray *xCoefs1 = [[IOSFloatArray alloc] initWithLength:4];
  IOSFloatArray *yCoefs1 = [[IOSFloatArray alloc] initWithLength:4];
  IOSFloatArray *xCoefs2 = [[IOSFloatArray alloc] initWithLength:4];
  IOSFloatArray *yCoefs2 = [[IOSFloatArray alloc] initWithLength:4];
