...
#if !PythagorasFPath_RESTRICT
#define PythagorasFPath_INCLUDE_ALL 1
#endif
#undef PythagorasFPath_RESTRICT

#if !defined (_PythagorasFPath_) && (PythagorasFPath_INCLUDE_ALL || PythagorasFPath_INCLUDE)
#define _PythagorasFPath_
...
#if !defined (_PythagorasFPath_Iterator_) && (PythagorasFPath_INCLUDE_ALL || PythagorasFPath_Iterator_INCLUDE)
#define _PythagorasFPath_Iterator_

@class IOSFloatArray;
@class PythagorasFPath;
@protocol PythagorasFTransform;
