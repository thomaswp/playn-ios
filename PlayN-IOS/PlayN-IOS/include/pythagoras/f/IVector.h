...
#if !PythagorasFIVector_RESTRICT
#define PythagorasFIVector_INCLUDE_ALL 1
#endif
#undef PythagorasFIVector_RESTRICT

#if !defined (_PythagorasFIVector_) && (PythagorasFIVector_INCLUDE_ALL || PythagorasFIVector_INCLUDE)
#define _PythagorasFIVector_
...
@protocol PythagorasFIVector < PythagorasFXY, NSObject, JavaObject >
