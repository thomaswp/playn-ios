...
#if !PythagorasFAffineTransform_RESTRICT
#define PythagorasFAffineTransform_INCLUDE_ALL 1
#endif
#undef PythagorasFAffineTransform_RESTRICT

#if !defined (_PythagorasFAffineTransform_) && (PythagorasFAffineTransform_INCLUDE_ALL || PythagorasFAffineTransform_INCLUDE)
#define _PythagorasFAffineTransform_
