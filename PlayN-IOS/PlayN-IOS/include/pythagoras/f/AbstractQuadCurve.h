...
#if !PythagorasFAbstractQuadCurve_RESTRICT
#define PythagorasFAbstractQuadCurve_INCLUDE_ALL 1
#endif
#undef PythagorasFAbstractQuadCurve_RESTRICT

#if !defined (_PythagorasFAbstractQuadCurve_) && (PythagorasFAbstractQuadCurve_INCLUDE_ALL || PythagorasFAbstractQuadCurve_INCLUDE)
#define _PythagorasFAbstractQuadCurve_
...
#define PythagorasFIQuadCurve_RESTRICT 1
#define PythagorasFIQuadCurve_INCLUDE 1
...
#if !defined (_PythagorasFAbstractQuadCurve_Iterator_) && (PythagorasFAbstractQuadCurve_INCLUDE_ALL || PythagorasFAbstractQuadCurve_Iterator_INCLUDE)
#define _PythagorasFAbstractQuadCurve_Iterator_
