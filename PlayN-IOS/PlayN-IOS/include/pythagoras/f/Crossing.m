...
+ (int)crossQuadWithFloat:(float)x1
  ...
  IOSFloatArray *res = [[IOSFloatArray alloc] initWithLength:3];
...
+ (int)intersectQuadWithFloat:(float)x1
  ...
  float px2 = rx2 - x1;
  float py2 = ry2 - y1;
  IOSFloatArray *res1 = [[IOSFloatArray alloc] initWithLength:3];
  IOSFloatArray *res2 = [[IOSFloatArray alloc] initWithLength:3];
  ...
  IOSFloatArray *bound = [[IOSFloatArray alloc] initWithLength:28];
  int bc = 0;
...
+ (int)intersectCubicWithFloat:(float)x1
  ...
  float minX = px1 - PythagorasFCrossing_DELTA;
  float maxX = px2 + PythagorasFCrossing_DELTA;
  IOSFloatArray *bound = [[IOSFloatArray alloc] initWithLength:40];
  int bc = 0;
