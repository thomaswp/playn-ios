...
#if !PythagorasFAbstractTransform_RESTRICT
#define PythagorasFAbstractTransform_INCLUDE_ALL 1
#endif
#undef PythagorasFAbstractTransform_RESTRICT

#if !defined (_PythagorasFAbstractTransform_) && (PythagorasFAbstractTransform_INCLUDE_ALL || PythagorasFAbstractTransform_INCLUDE)
#define _PythagorasFAbstractTransform_
