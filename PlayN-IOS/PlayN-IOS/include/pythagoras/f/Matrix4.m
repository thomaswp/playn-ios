...
#include "pythagoras/f/Matrix4.h"
...
- (PythagorasFMatrix4 *)setToRotationWithPythagorasFIVector3:(id<PythagorasFIVector3>)from
  ...
  if (angle <= PythagorasFFloatMath_PI - PythagorasFMathUtil_EPSILON) {
    return [self setToRotationWithFloat:angle withPythagorasFIVector3:[((PythagorasFVector3 *) nil_chk([((id<PythagorasFIVector3>) nil_chk(from)) crossWithPythagorasFIVector3:to])) normalizeLocal]];
  }
...
- (PythagorasFMatrix4 *)setWithFloatArray:(IOSFloatArray *)values {
...
- (PythagorasFMatrix4 *)transpose {
  return [self transposeWithPythagorasFMatrix4:[[PythagorasFMatrix4 alloc] init]];
}
...
- (PythagorasFMatrix4 *)multWithPythagorasFIMatrix4:(id<PythagorasFIMatrix4>)other {
  return [self multWithPythagorasFIMatrix4:other withPythagorasFMatrix4:[[PythagorasFMatrix4 alloc] init]];
}
...
- (PythagorasFMatrix4 *)multAffineWithPythagorasFIMatrix4:(id<PythagorasFIMatrix4>)other {
  return [self multAffineWithPythagorasFIMatrix4:other withPythagorasFMatrix4:[[PythagorasFMatrix4 alloc] init]];
}
...
- (PythagorasFMatrix4 *)invert {
  return [self invertWithPythagorasFMatrix4:[[PythagorasFMatrix4 alloc] init]];
}
...
- (PythagorasFMatrix4 *)invertAffine {
  return [self invertAffineWithPythagorasFMatrix4:[[PythagorasFMatrix4 alloc] init]];
}
...
- (PythagorasFMatrix4 *)lerpWithPythagorasFIMatrix4:(id<PythagorasFIMatrix4>)other
                                          withFloat:(float)t {
  return [self lerpWithPythagorasFIMatrix4:other withFloat:t withPythagorasFMatrix4:[[PythagorasFMatrix4 alloc] init]];
}
...
- (PythagorasFMatrix4 *)lerpAffineWithPythagorasFIMatrix4:(id<PythagorasFIMatrix4>)other
                                                withFloat:(float)t {
  return [self lerpAffineWithPythagorasFIMatrix4:other withFloat:t withPythagorasFMatrix4:[[PythagorasFMatrix4 alloc] init]];
}
...
- (JavaNioFloatBuffer *)getWithJavaNioFloatBuffer:(JavaNioFloatBuffer *)buf {
  (void) [((JavaNioFloatBuffer *) nil_chk([((JavaNioFloatBuffer *) nil_chk([((JavaNioFloatBuffer *) nil_chk([((JavaNioFloatBuffer *) nil_chk(buf)) putWithFloat:m00__])) putWithFloat:m01__])) putWithFloat:m02__])) putWithFloat:m03__];
  (void) [((JavaNioFloatBuffer *) nil_chk([((JavaNioFloatBuffer *) nil_chk([((JavaNioFloatBuffer *) nil_chk([((JavaNioFloatBuffer *) nil_chk(buf)) putWithFloat:m10__])) putWithFloat:m11__])) putWithFloat:m12__])) putWithFloat:m13__];
  (void) [((JavaNioFloatBuffer *) nil_chk([((JavaNioFloatBuffer *) nil_chk([((JavaNioFloatBuffer *) nil_chk([((JavaNioFloatBuffer *) nil_chk(buf)) putWithFloat:m20__])) putWithFloat:m21__])) putWithFloat:m22__])) putWithFloat:m23__];
  (void) [((JavaNioFloatBuffer *) nil_chk([((JavaNioFloatBuffer *) nil_chk([((JavaNioFloatBuffer *) nil_chk([((JavaNioFloatBuffer *) nil_chk(buf)) putWithFloat:m30__])) putWithFloat:m31__])) putWithFloat:m32__])) putWithFloat:m33__];
  return buf;
}
...
- (PythagorasFVector3 *)projectPointWithPythagorasFIVector3:(id<PythagorasFIVector3>)point {
  return [self projectPointWithPythagorasFIVector3:point withPythagorasFVector3:[[PythagorasFVector3 alloc] init]];
}
...
- (PythagorasFVector3 *)transformPointWithPythagorasFIVector3:(id<PythagorasFIVector3>)point {
  return [self transformPointWithPythagorasFIVector3:point withPythagorasFVector3:[[PythagorasFVector3 alloc] init]];
}
...
- (PythagorasFVector3 *)transformVectorWithPythagorasFIVector3:(id<PythagorasFIVector3>)vector {
  return [self transformVectorWithPythagorasFIVector3:vector withPythagorasFVector3:[[PythagorasFVector3 alloc] init]];
}
...
- (PythagorasFVector4 *)transformWithPythagorasFIVector4:(id<PythagorasFIVector4>)vector {
  return [self transformWithPythagorasFIVector4:vector withPythagorasFVector4:[[PythagorasFVector4 alloc] init]];
}
...
- (PythagorasFQuaternion *)extractRotation {
  return [self extractRotationWithPythagorasFQuaternion:[[PythagorasFQuaternion alloc] init]];
}
...
- (PythagorasFVector3 *)extractScale {
  return [self extractScaleWithPythagorasFVector3:[[PythagorasFVector3 alloc] init]];
}
...
+ (void)initialize {
  if (self == [PythagorasFMatrix4 class]) {
    PythagorasFMatrix4_IDENTITY_ = [[PythagorasFMatrix4 alloc] init];
    PythagorasFMatrix4_EMPTY_ARRAY_ = [IOSObjectArray arrayWithLength:0 type:[IOSClass classWithClass:[PythagorasFMatrix4 class]]];
  }
}
