...
- (IOSObjectArray *)findCrossing {
  IOSFloatArray *edge1 = [[IOSFloatArray alloc] initWithLength:8];
  IOSFloatArray *edge2 = [[IOSFloatArray alloc] initWithLength:8];
  IOSFloatArray *points = [[IOSFloatArray alloc] initWithLength:6];
  IOSFloatArray *params = [[IOSFloatArray alloc] initWithLength:6];
  IOSFloatArray *mp1 = [[IOSFloatArray alloc] initWithLength:2];
  IOSFloatArray *cp1 = [[IOSFloatArray alloc] initWithLength:2];
  IOSFloatArray *mp2 = [[IOSFloatArray alloc] initWithLength:2];
  IOSFloatArray *cp2 = [[IOSFloatArray alloc] initWithLength:2];
  ...
  return [((id<JavaUtilList>) NIL_CHK(isectPoints_)) toArrayWithNSObjectArray:[[IOSObjectArray alloc] initWithLength:[((id<JavaUtilList>) NIL_CHK(isectPoints_)) size] type:[IOSClass classWithClass:[PythagorasFIntersectPoint class]]]];
}
