...
- (id<PythagorasFTransform>)concatenateWithPythagorasFTransform:(id<PythagorasFTransform>)other {
  ...
  if ([(id) other isKindOfClass:[PythagorasFAffineTransform class]]) {
    return ((PythagorasFAffineTransform *) [PythagorasFTransforms multiplyWithPythagorasFAffineTransform:self withPythagorasFAffineTransform:(PythagorasFAffineTransform *) other withId:[[PythagorasFAffineTransform alloc] init]]);
  }
  else {
...
- (id<PythagorasFTransform>)preConcatenateWithPythagorasFTransform:(id<PythagorasFTransform>)other {
  ...
  if ([(id) other isKindOfClass:[PythagorasFAffineTransform class]]) {
    return ((PythagorasFAffineTransform *) [PythagorasFTransforms multiplyWithPythagorasFAffineTransform:(PythagorasFAffineTransform *) other withPythagorasFAffineTransform:self withId:[[PythagorasFAffineTransform alloc] init]]);
  }
  else {
    PythagorasFAffineTransform *oaff = [[PythagorasFAffineTransform alloc] initWithPythagorasFTransform:other];
