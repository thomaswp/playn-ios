...
- (void)getWithFloatArray:(IOSFloatArray *)matrix {
  (*[((IOSFloatArray *) nil_chk(matrix)) floatRefAtIndex:0]) = m00_;
  (*[((IOSFloatArray *) nil_chk(matrix)) floatRefAtIndex:1]) = m01_;
  (*[((IOSFloatArray *) nil_chk(matrix)) floatRefAtIndex:2]) = m10_;
  (*[((IOSFloatArray *) nil_chk(matrix)) floatRefAtIndex:3]) = m11_;
  (*[((IOSFloatArray *) nil_chk(matrix)) floatRefAtIndex:4]) = tx__;
  (*[((IOSFloatArray *) nil_chk(matrix)) floatRefAtIndex:5]) = ty__;
}
...
- (id<PythagorasFTransform>)scale__WithFloat:(float)scaleX
                                   withFloat:(float)scaleY {
  return [PythagorasFTransforms multiplyWithPythagorasFAffineTransform:self withFloat:scaleX withFloat:0 withFloat:0 withFloat:scaleY withFloat:0 withFloat:0 withId:self];
}

- (id<PythagorasFTransform>)scaleXWithFloat:(float)scaleX {
  return [PythagorasFTransforms multiplyWithPythagorasFAffineTransform:self withFloat:scaleX withFloat:0 withFloat:0 withFloat:1 withFloat:0 withFloat:0 withId:self];
}

- (id<PythagorasFTransform>)scaleYWithFloat:(float)scaleY {
  return [PythagorasFTransforms multiplyWithPythagorasFAffineTransform:self withFloat:1 withFloat:0 withFloat:0 withFloat:scaleY withFloat:0 withFloat:0 withId:self];
}

- (id<PythagorasFTransform>)rotateWithFloat:(float)angle {
  float sina = [PythagorasFFloatMath sinWithFloat:angle], cosa = [PythagorasFFloatMath cosWithFloat:angle];
  return [PythagorasFTransforms multiplyWithPythagorasFAffineTransform:self withFloat:cosa withFloat:sina withFloat:-sina withFloat:cosa withFloat:0 withFloat:0 withId:self];
}

- (id<PythagorasFTransform>)translateWithFloat:(float)tx
                                     withFloat:(float)ty {
  return [PythagorasFTransforms multiplyWithPythagorasFAffineTransform:self withFloat:1 withFloat:0 withFloat:0 withFloat:1 withFloat:tx withFloat:ty withId:self];
}

- (id<PythagorasFTransform>)translateXWithFloat:(float)tx {
  return [PythagorasFTransforms multiplyWithPythagorasFAffineTransform:self withFloat:1 withFloat:0 withFloat:0 withFloat:1 withFloat:tx withFloat:0 withId:self];
}

- (id<PythagorasFTransform>)translateYWithFloat:(float)ty {
  return [PythagorasFTransforms multiplyWithPythagorasFAffineTransform:self withFloat:1 withFloat:0 withFloat:0 withFloat:1 withFloat:0 withFloat:ty withId:self];
}

- (id<PythagorasFTransform>)shearWithFloat:(float)sx
                                 withFloat:(float)sy {
  return [PythagorasFTransforms multiplyWithPythagorasFAffineTransform:self withFloat:1 withFloat:sy withFloat:sx withFloat:1 withFloat:0 withFloat:0 withId:self];
}

- (id<PythagorasFTransform>)shearXWithFloat:(float)sx {
  return [PythagorasFTransforms multiplyWithPythagorasFAffineTransform:self withFloat:1 withFloat:0 withFloat:sx withFloat:1 withFloat:0 withFloat:0 withId:self];
}

- (id<PythagorasFTransform>)shearYWithFloat:(float)sy {
  return [PythagorasFTransforms multiplyWithPythagorasFAffineTransform:self withFloat:1 withFloat:sy withFloat:0 withFloat:1 withFloat:0 withFloat:0 withId:self];
}
...
- (id<PythagorasFTransform>)invert {
  ...
  float rdet = 1.0f / det;
  return [[PythagorasFAffineTransform alloc] initWithFloat:+m11_ * rdet withFloat:-m10_ * rdet withFloat:-m01_ * rdet withFloat:+m00_ * rdet withFloat:(m10_ * ty__ - m11_ * tx__) * rdet withFloat:(m01_ * tx__ - m00_ * ty__) * rdet];
}
...
- (id<PythagorasFTransform>)concatenateWithPythagorasFTransform:(id<PythagorasFTransform>)other {
  ...
  if ([(id) other isKindOfClass:[PythagorasFAffineTransform class]]) {
    return [PythagorasFTransforms multiplyWithPythagorasFAffineTransform:self withPythagorasFAffineTransform:(PythagorasFAffineTransform *) other withId:[[PythagorasFAffineTransform alloc] init]];
  }
  else {
    PythagorasFAffineTransform *oaff = [[PythagorasFAffineTransform alloc] initWithPythagorasFTransform:other];
    return [PythagorasFTransforms multiplyWithPythagorasFAffineTransform:self withPythagorasFAffineTransform:oaff withId:oaff];
  }
}
...
- (id<PythagorasFTransform>)preConcatenateWithPythagorasFTransform:(id<PythagorasFTransform>)other {
  ...
  if ([(id) other isKindOfClass:[PythagorasFAffineTransform class]]) {
    return [PythagorasFTransforms multiplyWithPythagorasFAffineTransform:(PythagorasFAffineTransform *) other withPythagorasFAffineTransform:self withId:[[PythagorasFAffineTransform alloc] init]];
  }
  else {
    PythagorasFAffineTransform *oaff = [[PythagorasFAffineTransform alloc] initWithPythagorasFTransform:other];
    return [PythagorasFTransforms multiplyWithPythagorasFAffineTransform:oaff withPythagorasFAffineTransform:self withId:oaff];
  }
}
...
- (id<PythagorasFTransform>)lerpWithPythagorasFTransform:(id<PythagorasFTransform>)other
  ...
  PythagorasFAffineTransform *ot = ([(id) other isKindOfClass:[PythagorasFAffineTransform class]]) ? (PythagorasFAffineTransform *) other : [[PythagorasFAffineTransform alloc] initWithPythagorasFTransform:other];
...
- (void)transformWithFloatArray:(IOSFloatArray *)src
  ...
  for (int ii = 0; ii < count; ii++) {
    ...
    (*[((IOSFloatArray *) nil_chk(dst)) floatRefAtIndex:dstOff++]) = m00_ * x + m10_ * y + tx__;
    (*[((IOSFloatArray *) nil_chk(dst)) floatRefAtIndex:dstOff++]) = m01_ * x + m11_ * y + ty__;
  }
}
...
- (id<PythagorasFTransform>)copy__ OBJC_METHOD_FAMILY_NONE {
  return [[PythagorasFAffineTransform alloc] initWithFloat:m00_ withFloat:m01_ withFloat:m10_ withFloat:m11_ withFloat:tx__ withFloat:ty__];
}
