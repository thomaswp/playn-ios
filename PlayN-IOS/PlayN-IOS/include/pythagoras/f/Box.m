...
- (id)initWithPythagorasFIVector3:(id<PythagorasFIVector3>)minExtent
  ...
  if ((self = [super init])) {
    _minExtent_ = [[PythagorasFVector3 alloc] init];
    _maxExtent_ = [[PythagorasFVector3 alloc] init];
...
- (PythagorasFBox *)fromPointsWithPythagorasFIVector3Array:(IOSObjectArray *)points {
  (void) [self setToEmpty];
  {
    ...
    for (int i__ = 0; i__ < n__; i__++) {
      id<PythagorasFIVector3> point = [((IOSObjectArray *) nil_chk(a__)) objectAtIndex:i__];
...
- (PythagorasFVector3 *)center {
  return [self centerWithPythagorasFVector3:[[PythagorasFVector3 alloc] init]];
}

- (PythagorasFVector3 *)centerWithPythagorasFVector3:(PythagorasFVector3 *)result {
  return [((PythagorasFVector3 *) nil_chk([((PythagorasFVector3 *) nil_chk(_minExtent_)) addWithPythagorasFIVector3:_maxExtent_ withPythagorasFVector3:result])) multLocalWithFloat:0.5f];
}
...
- (PythagorasFBox *)projectWithPythagorasFIMatrix4:(id<PythagorasFIMatrix4>)matrix
  ...
  (void) [((PythagorasFVector3 *) nil_chk(((PythagorasFBox *) nil_chk(result))._minExtent)) setWithFloat:minx withFloat:miny withFloat:minz];
  (void) [((PythagorasFVector3 *) nil_chk(((PythagorasFBox *) nil_chk(result))._maxExtent)) setWithFloat:maxx withFloat:maxy withFloat:maxz];
  return result;
}
...
- (PythagorasFBox *)expandWithFloat:(float)x
                          withFloat:(float)y
                          withFloat:(float)z {
  return [self expandWithFloat:x withFloat:y withFloat:z withPythagorasFBox:[[PythagorasFBox alloc] init]];
}
...
- (PythagorasFBox *)expandWithFloat:(float)x
                          ...
                          withFloat:(float)z
                 withPythagorasFBox:(PythagorasFBox *)result {
  (void) [((PythagorasFVector3 *) nil_chk(((PythagorasFBox *) nil_chk(result))._minExtent)) setWithFloat:((PythagorasFVector3 *) nil_chk(_minExtent_)).x_ - x withFloat:((PythagorasFVector3 *) nil_chk(_minExtent_)).y_ - y withFloat:((PythagorasFVector3 *) nil_chk(_minExtent_)).z_ - z];
  (void) [((PythagorasFVector3 *) nil_chk(((PythagorasFBox *) nil_chk(result))._maxExtent)) setWithFloat:((PythagorasFVector3 *) nil_chk(_maxExtent_)).x_ + x withFloat:((PythagorasFVector3 *) nil_chk(_maxExtent_)).y_ + y withFloat:((PythagorasFVector3 *) nil_chk(_maxExtent_)).z_ + z];
  return result;
}
...
- (float)extentDistanceWithPythagorasFIBox:(id<PythagorasFIBox>)other {
  return [((id<PythagorasFIVector3>) nil_chk([((id<PythagorasFIBox>) nil_chk(other)) minimumExtent])) manhattanDistanceWithPythagorasFIVector3:_minExtent_] + [((id<PythagorasFIVector3>) nil_chk([((id<PythagorasFIBox>) nil_chk(other)) maximumExtent])) manhattanDistanceWithPythagorasFIVector3:_maxExtent_];
}
...
+ (void)initialize {
  if (self == [PythagorasFBox class]) {
    PythagorasFBox_UNIT_ = [[PythagorasFBox alloc] initWithPythagorasFIVector3:[((id<PythagorasFIVector3>) nil_chk([PythagorasFVector3 UNIT_XYZ])) negate] withPythagorasFIVector3:[PythagorasFVector3 UNIT_XYZ]];
    PythagorasFBox_ZERO_ = [[PythagorasFBox alloc] initWithPythagorasFIVector3:[PythagorasFVector3 ZERO] withPythagorasFIVector3:[PythagorasFVector3 ZERO]];
    PythagorasFBox_EMPTY_ = [[PythagorasFBox alloc] initWithPythagorasFIVector3:[PythagorasFVector3 MAX_VALUE] withPythagorasFIVector3:[PythagorasFVector3 MIN_VALUE]];
    PythagorasFBox_MAX_VALUE_ = [[PythagorasFBox alloc] initWithPythagorasFIVector3:[PythagorasFVector3 MIN_VALUE] withPythagorasFIVector3:[PythagorasFVector3 MAX_VALUE]];
  }
}
