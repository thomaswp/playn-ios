...
- (PythagorasFVector3 *)crossWithPythagorasFIVector3:(id<PythagorasFIVector3>)other {
  return [self crossWithPythagorasFIVector3:other withPythagorasFVector3:[[PythagorasFVector3 alloc] init]];
}
...
- (PythagorasFVector3 *)negate {
  return [self negateWithPythagorasFVector3:[[PythagorasFVector3 alloc] init]];
}
...
- (PythagorasFVector3 *)abs {
  return [self absWithPythagorasFVector3:[[PythagorasFVector3 alloc] init]];
}
...
- (PythagorasFVector3 *)normalize {
  return [self normalizeWithPythagorasFVector3:[[PythagorasFVector3 alloc] init]];
}
...
- (PythagorasFVector3 *)multWithFloat:(float)v {
  return [self multWithFloat:v withPythagorasFVector3:[[PythagorasFVector3 alloc] init]];
}
...
- (PythagorasFVector3 *)multWithPythagorasFIVector3:(id<PythagorasFIVector3>)other {
  return [self multWithPythagorasFIVector3:other withPythagorasFVector3:[[PythagorasFVector3 alloc] init]];
}
...
- (PythagorasFVector3 *)addWithPythagorasFIVector3:(id<PythagorasFIVector3>)other {
  return [self addWithPythagorasFIVector3:other withPythagorasFVector3:[[PythagorasFVector3 alloc] init]];
}
...
- (PythagorasFVector3 *)subtractWithPythagorasFIVector3:(id<PythagorasFIVector3>)other {
  return [self subtractWithPythagorasFIVector3:other withPythagorasFVector3:[[PythagorasFVector3 alloc] init]];
}
...
- (PythagorasFVector3 *)addWithFloat:(float)x
                           withFloat:(float)y
                           withFloat:(float)z {
  return [self addWithFloat:x withFloat:y withFloat:z withPythagorasFVector3:[[PythagorasFVector3 alloc] init]];
}
...
- (PythagorasFVector3 *)addScaledWithPythagorasFIVector3:(id<PythagorasFIVector3>)other
                                               withFloat:(float)v {
  return [self addScaledWithPythagorasFIVector3:other withFloat:v withPythagorasFVector3:[[PythagorasFVector3 alloc] init]];
}
...
- (PythagorasFVector3 *)lerpWithPythagorasFIVector3:(id<PythagorasFIVector3>)other
                                          withFloat:(float)t {
  return [self lerpWithPythagorasFIVector3:other withFloat:t withPythagorasFVector3:[[PythagorasFVector3 alloc] init]];
}
...
- (JavaNioFloatBuffer *)getWithJavaNioFloatBuffer:(JavaNioFloatBuffer *)buf {
  return [((JavaNioFloatBuffer *) nil_chk([((JavaNioFloatBuffer *) nil_chk([((JavaNioFloatBuffer *) nil_chk(buf)) putWithFloat:x__])) putWithFloat:y__])) putWithFloat:z__];
}
...
+ (void)initialize {
  if (self == [PythagorasFVector3 class]) {
    PythagorasFVector3_UNIT_X_ = [[PythagorasFVector3 alloc] initWithFloat:1.0f withFloat:0.0f withFloat:0.0f];
    PythagorasFVector3_UNIT_Y_ = [[PythagorasFVector3 alloc] initWithFloat:0.0f withFloat:1.0f withFloat:0.0f];
    PythagorasFVector3_UNIT_Z_ = [[PythagorasFVector3 alloc] initWithFloat:0.0f withFloat:0.0f withFloat:1.0f];
    PythagorasFVector3_UNIT_XYZ_ = [[PythagorasFVector3 alloc] initWithFloat:1.0f withFloat:1.0f withFloat:1.0f];
    PythagorasFVector3_NORMAL_XYZ_ = [((id<PythagorasFIVector3>) nil_chk(PythagorasFVector3_UNIT_XYZ_)) normalize];
    PythagorasFVector3_ZERO_ = [[PythagorasFVector3 alloc] initWithFloat:0.0f withFloat:0.0f withFloat:0.0f];
    PythagorasFVector3_MIN_VALUE_ = [[PythagorasFVector3 alloc] initWithFloat:-JavaLangFloat_MAX_VALUE withFloat:-JavaLangFloat_MAX_VALUE withFloat:-JavaLangFloat_MAX_VALUE];
    PythagorasFVector3_MAX_VALUE_ = [[PythagorasFVector3 alloc] initWithFloat:JavaLangFloat_MAX_VALUE withFloat:JavaLangFloat_MAX_VALUE withFloat:JavaLangFloat_MAX_VALUE];
  }
}
