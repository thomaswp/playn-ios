...
#if !PythagorasFMathUtil_RESTRICT
#define PythagorasFMathUtil_INCLUDE_ALL 1
#endif
#undef PythagorasFMathUtil_RESTRICT

#if !defined (_PythagorasFMathUtil_) && (PythagorasFMathUtil_INCLUDE_ALL || PythagorasFMathUtil_INCLUDE)
#define _PythagorasFMathUtil_
