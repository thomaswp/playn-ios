...
#if !PythagorasFIMatrix3_RESTRICT
#define PythagorasFIMatrix3_INCLUDE_ALL 1
#endif
#undef PythagorasFIMatrix3_RESTRICT

#if !defined (_PythagorasFIMatrix3_) && (PythagorasFIMatrix3_INCLUDE_ALL || PythagorasFIMatrix3_INCLUDE)
#define _PythagorasFIMatrix3_
...
@protocol PythagorasFIMatrix3 < NSObject, JavaObject >
- (float)m00;
- (float)m10;
- (float)m20;
- (float)m01;
