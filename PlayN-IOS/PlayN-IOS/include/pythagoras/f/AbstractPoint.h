...
#if !PythagorasFAbstractPoint_RESTRICT
#define PythagorasFAbstractPoint_INCLUDE_ALL 1
#endif
#undef PythagorasFAbstractPoint_RESTRICT

#if !defined (_PythagorasFAbstractPoint_) && (PythagorasFAbstractPoint_INCLUDE_ALL || PythagorasFAbstractPoint_INCLUDE)
#define _PythagorasFAbstractPoint_

@class PythagorasFPoint;

#define PythagorasFIPoint_RESTRICT 1
#define PythagorasFIPoint_INCLUDE 1
