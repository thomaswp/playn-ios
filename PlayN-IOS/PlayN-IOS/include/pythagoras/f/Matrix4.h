...
#if !PythagorasFMatrix4_RESTRICT
#define PythagorasFMatrix4_INCLUDE_ALL 1
#endif
#undef PythagorasFMatrix4_RESTRICT

#if !defined (_PythagorasFMatrix4_) && (PythagorasFMatrix4_INCLUDE_ALL || PythagorasFMatrix4_INCLUDE)
#define _PythagorasFMatrix4_
...
#define PythagorasFIMatrix4_RESTRICT 1
#define PythagorasFIMatrix4_INCLUDE 1
