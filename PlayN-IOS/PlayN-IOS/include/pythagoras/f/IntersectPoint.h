...
#if !PythagorasFIntersectPoint_RESTRICT
#define PythagorasFIntersectPoint_INCLUDE_ALL 1
#endif
#undef PythagorasFIntersectPoint_RESTRICT

#if !defined (_PythagorasFIntersectPoint_) && (PythagorasFIntersectPoint_INCLUDE_ALL || PythagorasFIntersectPoint_INCLUDE)
#define _PythagorasFIntersectPoint_
