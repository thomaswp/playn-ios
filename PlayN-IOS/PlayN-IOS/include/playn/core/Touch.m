...
- (PlaynCoreTouch_Event_Impl *)localizeWithPlaynCoreLayer:(id<PlaynCoreLayer>)hit {
  return [[PlaynCoreTouch_Event_Impl alloc] initWithPlaynCoreLayer:hit withPlaynCoreEvents_Flags:[self flags] withDouble:[self time] withFloat:[self x] withFloat:[self y] withInt:[self id__] withFloat:[self pressure] withFloat:[self size]];
}
...
- (void)addFieldsWithJavaLangStringBuilder:(JavaLangStringBuilder *)builder {
  ...
  (void) [((JavaLangStringBuilder *) nil_chk([((JavaLangStringBuilder *) nil_chk([((JavaLangStringBuilder *) nil_chk([((JavaLangStringBuilder *) nil_chk([((JavaLangStringBuilder *) nil_chk([((JavaLangStringBuilder *) nil_chk(builder)) appendWithNSString:@", id="])) appendWithInt:id__])) appendWithNSString:@", pressure="])) appendWithFloat:pressure__])) appendWithNSString:@", size="])) appendWithFloat:size__];
}
