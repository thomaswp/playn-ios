...
#if !PlaynCoreSurface_RESTRICT
#define PlaynCoreSurface_INCLUDE_ALL 1
#endif
#undef PlaynCoreSurface_RESTRICT

#if !defined (_PlaynCoreSurface_) && (PlaynCoreSurface_INCLUDE_ALL || PlaynCoreSurface_INCLUDE)
#define _PlaynCoreSurface_
...
@protocol PlaynCoreSurface < NSObject, JavaObject >
- (float)width;
- (float)height;
