...
- (BOOL)onPointerStartWithPlaynCorePointer_Event_Impl:(PlaynCorePointer_Event_Impl *)event
  ...
  [((id<PlaynCoreEvents_Flags>) nil_chk([((PlaynCorePointer_Event_Impl *) nil_chk(event)) flags])) setPreventDefaultWithBOOL:preventDefault];
  if (listener__ != nil) {
  ...
  return [((id<PlaynCoreEvents_Flags>) nil_chk([((PlaynCorePointer_Event_Impl *) nil_chk(event)) flags])) getPreventDefault];
}
