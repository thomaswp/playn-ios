...
#if !PlaynCoreJson_RESTRICT
#define PlaynCoreJson_INCLUDE_ALL 1
#endif
#undef PlaynCoreJson_RESTRICT
#if PlaynCoreJson_TypedArray_Util_$1_INCLUDE
#define PlaynCoreJson_TypedArray_INCLUDE 1
#endif

#if !defined (_PlaynCoreJson_) && (PlaynCoreJson_INCLUDE_ALL || PlaynCoreJson_INCLUDE)
#define _PlaynCoreJson_

@protocol PlaynCoreJson_Array;
@protocol PlaynCoreJson_Object;
@protocol PlaynCoreJson_Writer;

@protocol PlaynCoreJson < NSObject, JavaObject >
...
#if !defined (_PlaynCoreJson_Writer_) && (PlaynCoreJson_INCLUDE_ALL || PlaynCoreJson_Writer_INCLUDE)
#define _PlaynCoreJson_Writer_

#define PlaynCoreJsonJsonSink_RESTRICT 1
#define PlaynCoreJsonJsonSink_INCLUDE 1
#include "playn/core/json/JsonSink.h"

@protocol PlaynCoreJson_Writer < PlaynCoreJsonJsonSink, NSObject, JavaObject >
- (NSString *)write;
- (id<PlaynCoreJson_Writer>)useVerboseFormatWithBOOL:(BOOL)verbose;
@end
#endif

#if !defined (_PlaynCoreJson_TypedArray_Util_) && (PlaynCoreJson_INCLUDE_ALL || PlaynCoreJson_TypedArray_Util_INCLUDE)
#define _PlaynCoreJson_TypedArray_Util_
...
#if !defined (_PlaynCoreJson_TypedArray_) && (PlaynCoreJson_INCLUDE_ALL || PlaynCoreJson_TypedArray_INCLUDE)
#define _PlaynCoreJson_TypedArray_
...
@protocol PlaynCoreJson_TypedArray < JavaLangIterable, NSObject, JavaObject >
- (int)length;
...
#if !defined (_PlaynCoreJson_TypedArray_Util_$1_) && (PlaynCoreJson_INCLUDE_ALL || PlaynCoreJson_TypedArray_Util_$1_INCLUDE)
#define _PlaynCoreJson_TypedArray_Util_$1_
...
@property (nonatomic, strong) IOSObjectArray *val$data;
...
#if !defined (_PlaynCoreJson_Array_) && (PlaynCoreJson_INCLUDE_ALL || PlaynCoreJson_Array_INCLUDE)
#define _PlaynCoreJson_Array_
...
@protocol PlaynCoreJson_Array < NSObject, JavaObject >
- (int)length;
...
#if !defined (_PlaynCoreJson_Object_) && (PlaynCoreJson_INCLUDE_ALL || PlaynCoreJson_Object_INCLUDE)
#define _PlaynCoreJson_Object_
...
@protocol PlaynCoreJson_Object < NSObject, JavaObject >
