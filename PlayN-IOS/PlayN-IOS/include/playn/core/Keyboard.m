...
- (void)addFieldsWithJavaLangStringBuilder:(JavaLangStringBuilder *)builder {
  ...
  (void) [((JavaLangStringBuilder *) nil_chk([((JavaLangStringBuilder *) nil_chk(builder)) appendWithNSString:@", key="])) appendWithId:key__];
}
...
- (void)addFieldsWithJavaLangStringBuilder:(JavaLangStringBuilder *)builder {
  [super addFieldsWithJavaLangStringBuilder:builder];
  (void) [((JavaLangStringBuilder *) nil_chk([((JavaLangStringBuilder *) nil_chk(builder)) appendWithNSString:@", typedChar="])) appendWithUnichar:typedChar__];
}
