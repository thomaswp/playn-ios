...
- (PlaynCorePointer_Event_Impl *)localizeWithPlaynCoreLayer:(id<PlaynCoreLayer>)hit {
  return [[PlaynCorePointer_Event_Impl alloc] initWithPlaynCoreLayer:hit withPlaynCoreEvents_Flags:[self flags] withDouble:[self time] withFloat:[self x] withFloat:[self y] withBOOL:[self isTouch]];
}
