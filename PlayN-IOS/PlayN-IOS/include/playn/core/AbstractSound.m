...
- (void)onLoadedWithId:(id)impl {
  self.impl = impl;
  callbacks_ = ((id<JavaUtilList>) [PlaynCoreUtilCallbacks dispatchSuccessClearWithJavaUtilList:callbacks_ withId:self]);
...
- (void)onLoadErrorWithJavaLangThrowable:(JavaLangThrowable *)error {
  self.error = error;
  callbacks_ = ((id<JavaUtilList>) [PlaynCoreUtilCallbacks dispatchFailureClearWithJavaUtilList:callbacks_ withJavaLangThrowable:error]);
}
...
- (void)addCallbackWithPlaynCoreUtilCallback:(id<PlaynCoreUtilCallback>)callback {
  ...
  else callbacks_ = ((id<JavaUtilList>) [PlaynCoreUtilCallbacks createAddWithJavaUtilList:callbacks_ withPlaynCoreUtilCallback:callback]);
}
