...
#if !PlaynCoreAsserts_RESTRICT
#define PlaynCoreAsserts_INCLUDE_ALL 1
#endif
#undef PlaynCoreAsserts_RESTRICT

#if !defined (_PlaynCoreAsserts_) && (PlaynCoreAsserts_INCLUDE_ALL || PlaynCoreAsserts_INCLUDE)
#define _PlaynCoreAsserts_
