...
#if !PlaynCoreAbstractLayer_RESTRICT
#define PlaynCoreAbstractLayer_INCLUDE_ALL 1
#endif
#undef PlaynCoreAbstractLayer_RESTRICT

#if !defined (_PlaynCoreAbstractLayer_) && (PlaynCoreAbstractLayer_INCLUDE_ALL || PlaynCoreAbstractLayer_INCLUDE)
#define _PlaynCoreAbstractLayer_
...
@property (nonatomic, strong) id<PlaynCoreInternalTransform> transform_;
@property (nonatomic, strong) id<PlaynCoreGroupLayer> parent_;
...
@property (nonatomic, strong) PlaynCoreAbstractLayer_Interactor *rootInteractor;
@property (nonatomic, strong) id<PlaynCoreLayer_HitTester> hitTester;
...
#if !defined (_PlaynCoreAbstractLayer_Interaction_) && (PlaynCoreAbstractLayer_INCLUDE_ALL || PlaynCoreAbstractLayer_Interaction_INCLUDE)
#define _PlaynCoreAbstractLayer_Interaction_

@protocol PlaynCoreAbstractLayer_Interaction < NSObject, JavaObject >
- (void)interactWithId:(id)listener
                withId:(id)argument;
@end
#endif

#if !defined (_PlaynCoreAbstractLayer_Interactor_) && (PlaynCoreAbstractLayer_INCLUDE_ALL || PlaynCoreAbstractLayer_Interactor_INCLUDE)
#define _PlaynCoreAbstractLayer_Interactor_
...
@property (nonatomic, strong) IOSClass *listenerType;
@property (nonatomic, strong) id listener;
@property (nonatomic, strong) PlaynCoreAbstractLayer_Interactor *next;
...
#if !defined (_PlaynCoreAbstractLayer_FlagEnum_) && (PlaynCoreAbstractLayer_INCLUDE_ALL || PlaynCoreAbstractLayer_FlagEnum_INCLUDE)
#define _PlaynCoreAbstractLayer_FlagEnum_
...
#if !defined (_PlaynCoreAbstractLayer_$1_) && (PlaynCoreAbstractLayer_INCLUDE_ALL || PlaynCoreAbstractLayer_$1_INCLUDE)
#define _PlaynCoreAbstractLayer_$1_

@class PlaynCoreAbstractLayer;
@class PlaynCoreAbstractLayer_Interactor;

#define PlaynCoreConnection_RESTRICT 1
#define PlaynCoreConnection_INCLUDE 1
...
@property (nonatomic, strong) PlaynCoreAbstractLayer *this$0;
@property (nonatomic, strong) PlaynCoreAbstractLayer_Interactor *val$newint;
