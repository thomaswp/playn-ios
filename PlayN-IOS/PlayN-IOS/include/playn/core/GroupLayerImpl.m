...
- (void)destroyWithPlaynCoreGroupLayer:(id<PlaynCoreGroupLayer>)self_ {
  IOSObjectArray *toDestroy = [((id<JavaUtilList>) NIL_CHK(children_)) toArrayWithNSObjectArray:[[IOSObjectArray alloc] initWithLength:[((id<JavaUtilList>) NIL_CHK(children_)) size] type:[IOSClass classWithClass:[PlaynCoreAbstractLayer class]]]];
