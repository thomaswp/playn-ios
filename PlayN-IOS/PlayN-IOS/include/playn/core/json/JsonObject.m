...
+ (PlaynCoreJsonJsonBuilder *)builder {
  return [[PlaynCoreJsonJsonBuilder alloc] initWithId:[[PlaynCoreJsonJsonObject alloc] init]];
}
...
- (id<PlaynCoreJson_TypedArray>)getArrayWithNSString:(NSString *)key
  ...
  return [self getArrayWithNSString:key withIOSClass:valueType withPlaynCoreJson_TypedArray:nil];
}
...
- (id<PlaynCoreJson_TypedArray>)getArrayWithNSString:(NSString *)key
  ...
  return array == nil ? ((id) dflt) : [[PlaynCoreJsonJsonTypedArray alloc] initWithPlaynCoreJson_Array:array withIOSClass:valueType];
}

- (id<PlaynCoreJson_TypedArray>)keys {
  return [[PlaynCoreJsonJsonStringTypedArray alloc] initWithJavaUtilCollection:[((JavaUtilHashMap *) nil_chk(map_)) keySet]];
}
...
- (id<PlaynCoreJsonJsonSink>)writeWithPlaynCoreJsonJsonSink:(id<PlaynCoreJsonJsonSink>)sink {
  {
    id<JavaUtilIterator> iter__ = [((id<JavaUtilSet>) nil_chk([((JavaUtilHashMap *) nil_chk(map_)) entrySet])) iterator];
    while ([((id<JavaUtilIterator>) nil_chk(iter__)) hasNext]) {
      id<JavaUtilMap_Entry> entry = [((id<JavaUtilIterator>) nil_chk(iter__)) next];
      (void) [((id<PlaynCoreJsonJsonSink>) nil_chk(sink)) valueWithNSString:[((id<JavaUtilMap_Entry>) nil_chk(entry)) getKey] withId:[((id<JavaUtilMap_Entry>) nil_chk(entry)) getValue]];
    }
  }
  return sink;
}
