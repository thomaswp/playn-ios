...
#if !PlaynCoreJsonJsonWriterBase_RESTRICT
#define PlaynCoreJsonJsonWriterBase_INCLUDE_ALL 1
#endif
#undef PlaynCoreJsonJsonWriterBase_RESTRICT

#if !defined (_PlaynCoreJsonJsonWriterBase_) && (PlaynCoreJsonJsonWriterBase_INCLUDE_ALL || PlaynCoreJsonJsonWriterBase_INCLUDE)
#define _PlaynCoreJsonJsonWriterBase_
...
@property (nonatomic, strong) id<JavaLangAppendable> appendable;
@property (nonatomic, strong) JavaUtilStack *states;
