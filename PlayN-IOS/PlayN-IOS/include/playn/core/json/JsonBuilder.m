...
- (id)initWithId:(id)root {
  if ((self = [super init])) {
    json_ = [[JavaUtilStack alloc] init];
    self.root = root;
...
- (PlaynCoreJsonJsonBuilder *)valueWithId:(id)o {
  [((PlaynCoreJsonJsonArray *) nil_chk([self arr])) addWithId:o];
  return self;
}

- (PlaynCoreJsonJsonBuilder *)valueWithNSString:(NSString *)key
                                         withId:(id)o {
  [((PlaynCoreJsonJsonObject *) nil_chk([self obj])) putWithNSString:key withId:o];
  return self;
}
...
- (PlaynCoreJsonJsonBuilder *)array {
  PlaynCoreJsonJsonArray *a = [[PlaynCoreJsonJsonArray alloc] init];
...
- (PlaynCoreJsonJsonBuilder *)object {
  PlaynCoreJsonJsonObject *o = [[PlaynCoreJsonJsonObject alloc] init];
...
- (PlaynCoreJsonJsonBuilder *)end {
  if ([((JavaUtilStack *) nil_chk(json_)) size] == 1) @throw [[PlaynCoreJsonJsonWriterException alloc] initWithNSString:@"Cannot end the root object or array"];
...
- (PlaynCoreJsonJsonObject *)obj {
  ...
  @catch (JavaLangClassCastException *e) {
    @throw [[PlaynCoreJsonJsonWriterException alloc] initWithNSString:@"Attempted to write a keyed value to a JsonArray"];
  }
}
...
- (PlaynCoreJsonJsonArray *)arr {
  ...
  @catch (JavaLangClassCastException *e) {
    @throw [[PlaynCoreJsonJsonWriterException alloc] initWithNSString:@"Attempted to write a non-keyed value to a JsonObject"];
  }
}
