...
#if !PlaynCoreJsonJsonArray_RESTRICT
#define PlaynCoreJsonJsonArray_INCLUDE_ALL 1
#endif
#undef PlaynCoreJsonJsonArray_RESTRICT

#if !defined (_PlaynCoreJsonJsonArray_) && (PlaynCoreJsonJsonArray_INCLUDE_ALL || PlaynCoreJsonJsonArray_INCLUDE)
#define _PlaynCoreJsonJsonArray_
...
#define PlaynCoreJson_Array_INCLUDE 1
