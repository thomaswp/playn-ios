...
+ (int)genBufferIdWithPlaynCoreGlGL20:(id<PlaynCoreGlGL20>)gl {
  IOSIntArray *ids = [[IOSIntArray alloc] initWithLength:1];
...
//  buffer__ = [[[JavaNioByteBuffer allocateDirectWithInt:capacity * PlaynCoreGlGL20Buffer_ShortImpl_BYTES_PER_SHORT] orderWithJavaNioByteOrder:[JavaNioByteOrder nativeOrder]] asShortBuffer];
}
