...
#if !PlaynCoreGlQuadShader_RESTRICT
#define PlaynCoreGlQuadShader_INCLUDE_ALL 1
#endif
#undef PlaynCoreGlQuadShader_RESTRICT

#if !defined (_PlaynCoreGlQuadShader_) && (PlaynCoreGlQuadShader_INCLUDE_ALL || PlaynCoreGlQuadShader_INCLUDE)
#define _PlaynCoreGlQuadShader_
...
#if !defined (_PlaynCoreGlQuadShader_QuadCore_) && (PlaynCoreGlQuadShader_INCLUDE_ALL || PlaynCoreGlQuadShader_QuadCore_INCLUDE)
#define _PlaynCoreGlQuadShader_QuadCore_

@class PlaynCoreGlQuadShader;
...
@property (nonatomic, strong) PlaynCoreGlQuadShader *this$1;
@property (nonatomic, strong) id<PlaynCoreGlGLShader_Uniform2f> uScreenSize;
@property (nonatomic, strong) id<PlaynCoreGlGLShader_Uniform4fv> uData;
@property (nonatomic, strong) id<PlaynCoreGlGLShader_Attrib> aVertex;
@property (nonatomic, strong) id<PlaynCoreGlGLBuffer_Float> data;
@property (nonatomic, strong) id<PlaynCoreGlGLBuffer_Short> vertices;
