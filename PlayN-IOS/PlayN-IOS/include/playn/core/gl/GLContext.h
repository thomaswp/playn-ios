...
#if !PlaynCoreGlGLContext_RESTRICT
#define PlaynCoreGlGLContext_INCLUDE_ALL 1
#endif
#undef PlaynCoreGlGLContext_RESTRICT

#if !defined (_PlaynCoreGlGLContext_) && (PlaynCoreGlGLContext_INCLUDE_ALL || PlaynCoreGlGLContext_INCLUDE)
#define _PlaynCoreGlGLContext_
...
@property (nonatomic, strong) PlaynCoreGlGLContext_Stats *stats_;
@property (nonatomic, strong) id<PlaynCorePlatform> platform;
@property (nonatomic, strong) PlaynCoreGlGLShader *curShader;
...
@property (nonatomic, strong) id<JavaUtilList> scissors;
...
#if !defined (_PlaynCoreGlGLContext_FilterEnum_) && (PlaynCoreGlGLContext_INCLUDE_ALL || PlaynCoreGlGLContext_FilterEnum_INCLUDE)
#define _PlaynCoreGlGLContext_FilterEnum_
...
#if !defined (_PlaynCoreGlGLContext_Stats_) && (PlaynCoreGlGLContext_INCLUDE_ALL || PlaynCoreGlGLContext_Stats_INCLUDE)
#define _PlaynCoreGlGLContext_Stats_
...
#if !defined (_PlaynCoreGlGLContext_$1_) && (PlaynCoreGlGLContext_INCLUDE_ALL || PlaynCoreGlGLContext_$1_INCLUDE)
#define _PlaynCoreGlGLContext_$1_
...
@property (nonatomic, strong) PlaynCoreGlGLContext *this$0;
...
#if !defined (_PlaynCoreGlGLContext_$2_) && (PlaynCoreGlGLContext_INCLUDE_ALL || PlaynCoreGlGLContext_$2_INCLUDE)
#define _PlaynCoreGlGLContext_$2_
...
#if !defined (_PlaynCoreGlGLContext_$3_) && (PlaynCoreGlGLContext_INCLUDE_ALL || PlaynCoreGlGLContext_$3_INCLUDE)
#define _PlaynCoreGlGLContext_$3_
...
@property (nonatomic, strong) PlaynCoreGlGLShader *val$shader;
