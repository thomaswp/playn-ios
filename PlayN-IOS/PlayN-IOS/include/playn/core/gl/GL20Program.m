...
- (id)initWithPlaynCoreGlGLContext:(PlaynCoreGlGLContext *)ctx
  ...
  if ((self = [super init])) {
    ...
    @try {
      ...
      if (program == 0) {
        @throw [[JavaLangRuntimeException alloc] initWithNSString:[NSString stringWithFormat:@"Failed to create program: %d", [((id<PlaynCoreGlGL20>) nil_chk(gl)) glGetError]]];
      }
      ...
      IOSIntArray *linkStatus = [IOSIntArray arrayWithLength:1];
      [((id<PlaynCoreGlGL20>) nil_chk(gl)) glGetProgramivWithInt:program withInt:PlaynCoreGlGL20_GL_LINK_STATUS withIntArray:linkStatus withInt:0];
      if ([((IOSIntArray *) nil_chk(linkStatus)) intAtIndex:0] == PlaynCoreGlGL20_GL_FALSE) {
        ...
        @throw [[JavaLangRuntimeException alloc] initWithNSString:[NSString stringWithFormat:@"Failed to link program: %@", log]];
      }
...
- (id<PlaynCoreGlGLShader_Uniform1f>)getUniform1fWithNSString:(NSString *)name {
  ...
  return (loc < 0) ? nil : [[PlaynCoreGlGL20Program_$1 alloc] initWithPlaynCoreGlGL20Program:self withInt:loc];
}

- (id<PlaynCoreGlGLShader_Uniform2f>)getUniform2fWithNSString:(NSString *)name {
  int loc = [((id<PlaynCoreGlGL20>) nil_chk(gl_)) glGetUniformLocationWithInt:program_ withNSString:name];
  return (loc < 0) ? nil : [[PlaynCoreGlGL20Program_$2 alloc] initWithPlaynCoreGlGL20Program:self withInt:loc];
}

- (id<PlaynCoreGlGLShader_Uniform3f>)getUniform3fWithNSString:(NSString *)name {
  int loc = [((id<PlaynCoreGlGL20>) nil_chk(gl_)) glGetUniformLocationWithInt:program_ withNSString:name];
  return (loc < 0) ? nil : [[PlaynCoreGlGL20Program_$3 alloc] initWithPlaynCoreGlGL20Program:self withInt:loc];
}

- (id<PlaynCoreGlGLShader_Uniform4f>)getUniform4fWithNSString:(NSString *)name {
  int loc = [((id<PlaynCoreGlGL20>) nil_chk(gl_)) glGetUniformLocationWithInt:program_ withNSString:name];
  return (loc < 0) ? nil : [[PlaynCoreGlGL20Program_$4 alloc] initWithPlaynCoreGlGL20Program:self withInt:loc];
}

- (id<PlaynCoreGlGLShader_Uniform1i>)getUniform1iWithNSString:(NSString *)name {
  int loc = [((id<PlaynCoreGlGL20>) nil_chk(gl_)) glGetUniformLocationWithInt:program_ withNSString:name];
  return (loc < 0) ? nil : [[PlaynCoreGlGL20Program_$5 alloc] initWithPlaynCoreGlGL20Program:self withInt:loc];
}

- (id<PlaynCoreGlGLShader_Uniform2i>)getUniform2iWithNSString:(NSString *)name {
  int loc = [((id<PlaynCoreGlGL20>) nil_chk(gl_)) glGetUniformLocationWithInt:program_ withNSString:name];
  return (loc < 0) ? nil : [[PlaynCoreGlGL20Program_$6 alloc] initWithPlaynCoreGlGL20Program:self withInt:loc];
}

- (id<PlaynCoreGlGLShader_Uniform2fv>)getUniform2fvWithNSString:(NSString *)name {
  int loc = [((id<PlaynCoreGlGL20>) nil_chk(gl_)) glGetUniformLocationWithInt:program_ withNSString:name];
  return (loc < 0) ? nil : [[PlaynCoreGlGL20Program_$7 alloc] initWithPlaynCoreGlGL20Program:self withInt:loc];
}

- (id<PlaynCoreGlGLShader_Uniform4fv>)getUniform4fvWithNSString:(NSString *)name {
  int loc = [((id<PlaynCoreGlGL20>) nil_chk(gl_)) glGetUniformLocationWithInt:program_ withNSString:name];
  return (loc < 0) ? nil : [[PlaynCoreGlGL20Program_$8 alloc] initWithPlaynCoreGlGL20Program:self withInt:loc];
}

- (id<PlaynCoreGlGLShader_UniformMatrix4fv>)getUniformMatrix4fvWithNSString:(NSString *)name {
  int loc = [((id<PlaynCoreGlGL20>) nil_chk(gl_)) glGetUniformLocationWithInt:program_ withNSString:name];
  return (loc < 0) ? nil : [[PlaynCoreGlGL20Program_$9 alloc] initWithPlaynCoreGlGL20Program:self withInt:loc];
}
...
- (id<PlaynCoreGlGLShader_Attrib>)getAttribWithNSString:(NSString *)name
  ...
  return (loc < 0) ? nil : [[PlaynCoreGlGL20Program_$10 alloc] initWithPlaynCoreGlGL20Program:self withInt:loc withInt:size withInt:type];
}
...
- (int)compileShaderWithInt:(int)type
  ...
  if (shader == 0) @throw [[JavaLangRuntimeException alloc] initWithNSString:[NSString stringWithFormat:@"Failed to create shader (%d): %d", type, [((id<PlaynCoreGlGL20>) nil_chk(gl_)) glGetError]]];
  ...
  IOSIntArray *compiled = [IOSIntArray arrayWithLength:1];
  [((id<PlaynCoreGlGL20>) nil_chk(gl_)) glGetShaderivWithInt:shader withInt:PlaynCoreGlGL20_GL_COMPILE_STATUS withIntArray:compiled withInt:0];
  if ([((IOSIntArray *) nil_chk(compiled)) intAtIndex:0] == PlaynCoreGlGL20_GL_FALSE) {
    ...
    @throw [[JavaLangRuntimeException alloc] initWithNSString:[NSString stringWithFormat:@"Failed to compile shader (%d): %@", type, log]];
  }
  return shader;
}
