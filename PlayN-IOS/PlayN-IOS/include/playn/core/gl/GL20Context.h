...
#if !PlaynCoreGlGL20Context_RESTRICT
#define PlaynCoreGlGL20Context_INCLUDE_ALL 1
#endif
#undef PlaynCoreGlGL20Context_RESTRICT

#if !defined (_PlaynCoreGlGL20Context_) && (PlaynCoreGlGL20Context_INCLUDE_ALL || PlaynCoreGlGL20Context_INCLUDE)
#define _PlaynCoreGlGL20Context_
...
#define PlaynCoreGlGLContext_RESTRICT 1
#define PlaynCoreGlGLContext_INCLUDE 1
...
@property (nonatomic, strong) id<PlaynCoreInternalTransform> rootXform;
@property (nonatomic, assign) int minFilter;
@property (nonatomic, assign) int magFilter;
@property (nonatomic, strong) PlaynCoreGlGLShader *quadShader_;
@property (nonatomic, strong) PlaynCoreGlGLShader *trisShader_;
