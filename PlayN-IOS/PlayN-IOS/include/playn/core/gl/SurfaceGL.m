...
- (id)initWithPlaynCoreGlGLContext:(PlaynCoreGlGLContext *)ctx
  ...
  if ((self = [super initWithPlaynCoreGlGLContext:ctx])) {
    self.width_ = width;
    self.height_ = height;
    self.texWidth = [((PlaynCoreGlScale *) nil_chk(((PlaynCoreGlGLContext *) nil_chk(ctx)).scale_)) scaledCeilWithFloat:width];
    self.texHeight = [((PlaynCoreGlScale *) nil_chk(((PlaynCoreGlGLContext *) nil_chk(ctx)).scale_)) scaledCeilWithFloat:height];
    [self createTexture];
    (void) [self scale__WithFloat:((PlaynCoreGlScale *) nil_chk(((PlaynCoreGlGLContext *) nil_chk(ctx)).scale_)).factor withFloat:((PlaynCoreGlScale *) nil_chk(((PlaynCoreGlGLContext *) nil_chk(ctx)).scale_)).factor];
  }
  return self;
}
...
- (void)drawWithPlaynCoreGlGLShader:(PlaynCoreGlGLShader *)shader
  ...
  [((PlaynCoreGlGLShader *) nil_chk([((PlaynCoreGlGLShader *) nil_chk([((PlaynCoreGlGLContext *) nil_chk(ctx_)) quadShaderWithPlaynCoreGlGLShader:shader])) prepareTextureWithInt:tex_ withInt:curTint])) addQuadWithPlaynCoreInternalTransform:xform withFloat:0 withFloat:height__ withFloat:width__ withFloat:0 withFloat:0 withFloat:0 withFloat:1 withFloat:1];
}
