...
- (void)cancelLayerTouchesWithPlaynCoreLayer:(id<PlaynCoreLayer>)except {
  ...
  while ([((id<JavaUtilIterator>) NIL_CHK(iter)) hasNext]) {
    ...
    PlaynCoreTouch_Event_Impl *event = [[PlaynCoreTouch_Event_Impl alloc] initWithPlaynCoreEvents_Flags:[[PlaynCoreEvents_Flags_Impl alloc] init] withDouble:now withFloat:0 withFloat:0 withInt:[((JavaLangInteger *) [((id<JavaUtilMap_Entry>) NIL_CHK(entry)) getKey]) intValue]];
