...
#if !PlaynCoreAbstractPlatform_RESTRICT
#define PlaynCoreAbstractPlatform_INCLUDE_ALL 1
#endif
#undef PlaynCoreAbstractPlatform_RESTRICT

#if !defined (_PlaynCoreAbstractPlatform_) && (PlaynCoreAbstractPlatform_INCLUDE_ALL || PlaynCoreAbstractPlatform_INCLUDE)
#define _PlaynCoreAbstractPlatform_
...
@property (nonatomic, strong) PlaynCoreUtilRunQueue *runQueue;
@property (nonatomic, strong) id<PlaynCoreLog> log_;
@property (nonatomic, strong) id<PlaynCorePlayN_LifecycleListener> lifecycleListener;
...
#if !defined (_PlaynCoreAbstractPlatform_$1_) && (PlaynCoreAbstractPlatform_INCLUDE_ALL || PlaynCoreAbstractPlatform_$1_INCLUDE)
#define _PlaynCoreAbstractPlatform_$1_
...
@property (nonatomic, strong) id val$result;
...
#if !defined (_PlaynCoreAbstractPlatform_$2_) && (PlaynCoreAbstractPlatform_INCLUDE_ALL || PlaynCoreAbstractPlatform_$2_INCLUDE)
#define _PlaynCoreAbstractPlatform_$2_
