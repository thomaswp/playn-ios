...
#if !PlaynCoreCanvasGraphicsCanvas_RESTRICT
#define PlaynCoreCanvasGraphicsCanvas_INCLUDE_ALL 1
#endif
#undef PlaynCoreCanvasGraphicsCanvas_RESTRICT

#if !defined (_PlaynCoreCanvasGraphicsCanvas_) && (PlaynCoreCanvasGraphicsCanvas_INCLUDE_ALL || PlaynCoreCanvasGraphicsCanvas_INCLUDE)
#define _PlaynCoreCanvasGraphicsCanvas_
...
@property (nonatomic, strong) PlaynCoreCanvasGroupLayerCanvas *rootLayer_;
