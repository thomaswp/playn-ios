...
#ifndef _TripleplayParticleInitAngle_H_
#define _TripleplayParticleInitAngle_H_
...
@interface TripleplayParticleInitAngle_$1 : TripleplayParticleInitializer {
 @public
...
#endif // _TripleplayParticleInitAngle_H_
