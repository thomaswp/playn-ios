...
- (void)init__WithInt:(int)index
  ...
  float scale_ = [TripleplayParticleGLStatus enabled] ? ((PlaynCoreGlScale *) nil_chk(((PlaynCoreGlGLContext *) nil_chk([((id<PlaynCoreGraphics>) nil_chk([PlaynCorePlayN graphics])) ctx])).scale_)).factor : 1;
