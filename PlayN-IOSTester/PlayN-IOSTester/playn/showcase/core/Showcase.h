...
#ifndef _PlaynShowcaseCoreShowcase_H_
#define _PlaynShowcaseCoreShowcase_H_
...
@protocol PlaynShowcaseCoreShowcase_DeviceService < NSObject, JavaObject >
- (NSString *)info;
@end
...
#endif // _PlaynShowcaseCoreShowcase_H_
