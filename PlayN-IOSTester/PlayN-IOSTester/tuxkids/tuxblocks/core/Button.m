...
- (void)setSizeWithFloat:(float)width
  ...
  self.width_ = width;
  self.height_ = height;
  if ([((id<PlaynCoreImage>) nil_chk([((TuxkidsTuxblocksCoreImageLayerTintable *) nil_chk(imageLayer__)) image])) isReady]) {
    [self adjustScale];
  }
}
...
- (void)setImageWithPlaynCoreImage:(id<PlaynCoreImage>)image {
  ...
  [((id<PlaynCoreImage>) nil_chk([((TuxkidsTuxblocksCoreImageLayerTintable *) nil_chk(imageLayer__)) image])) addCallbackWithPlaynCoreUtilCallback:[[TuxkidsTuxblocksCoreButton_$1 alloc] initWithTuxkidsTuxblocksCoreButton:self]];
}
...
- (void)adjustScale {
  [((TuxkidsTuxblocksCoreImageLayerTintable *) nil_chk(imageLayer__)) setScaleWithFloat:width__ / [((id<PlaynCoreImage>) nil_chk([((TuxkidsTuxblocksCoreImageLayerTintable *) nil_chk(imageLayer__)) image])) width] withFloat:height__ / [((id<PlaynCoreImage>) nil_chk([((TuxkidsTuxblocksCoreImageLayerTintable *) nil_chk(imageLayer__)) image])) height]];
}
