...
- (id<PlaynCoreLayer>)layerAddable {
  return [((TuxkidsTuxblocksCoreLayersImageLayerTintable *) nil_chk(imageLayer__)) layerAddable];
}

- (TuxkidsTuxblocksCoreLayersImageLayerTintable *)imageLayer {
  return imageLayer__;
}

- (id<PlaynCoreImage>)image {
  return [((TuxkidsTuxblocksCoreLayersImageLayerTintable *) nil_chk(imageLayer__)) image];
}

- (float)x {
  return [((TuxkidsTuxblocksCoreLayersImageLayerTintable *) nil_chk(imageLayer__)) tx];
}

- (float)y {
  return [((TuxkidsTuxblocksCoreLayersImageLayerTintable *) nil_chk(imageLayer__)) ty];
}
...
- (int)tint {
  return [((TuxkidsTuxblocksCoreLayersImageLayerTintable *) nil_chk(imageLayer__)) tint];
}
...
- (void)setXWithFloat:(float)x {
  [((TuxkidsTuxblocksCoreLayersImageLayerTintable *) nil_chk(imageLayer__)) setTxWithFloat:x];
}

- (void)setYWithFloat:(float)y {
  [((TuxkidsTuxblocksCoreLayersImageLayerTintable *) nil_chk(imageLayer__)) setTyWithFloat:y];
}

- (void)setPositionWithFloat:(float)x
                   withFloat:(float)y {
  [((TuxkidsTuxblocksCoreLayersImageLayerTintable *) nil_chk(imageLayer__)) setTranslationWithFloat:x withFloat:y];
}
...
- (void)setSizeWithFloat:(float)width
  ...
  self.width_ = width;
  self.height_ = height;
  if ([((id<PlaynCoreImage>) nil_chk([((TuxkidsTuxblocksCoreLayersImageLayerTintable *) nil_chk(imageLayer__)) image])) isReady]) {
    [self adjustScale];
  }
}

- (void)setImageWithPlaynCoreImage:(id<PlaynCoreImage>)image {
  [((TuxkidsTuxblocksCoreLayersImageLayerTintable *) nil_chk(imageLayer__)) setImageWithPlaynCoreImage:image];
  [((id<PlaynCoreImage>) nil_chk([((TuxkidsTuxblocksCoreLayersImageLayerTintable *) nil_chk(imageLayer__)) image])) addCallbackWithPlaynCoreUtilCallback:[[TuxkidsTuxblocksCoreButton_$1 alloc] initWithTuxkidsTuxblocksCoreButton:self]];
}
...
- (id)initWithNSString:(NSString *)imagePath
  ...
  return [self initTuxkidsTuxblocksCoreButtonWithPlaynCoreImage:[((id<PlaynCoreAssets>) nil_chk([TuxkidsTuxblocksCorePlayNObject assets])) getImageWithNSString:imagePath] withFloat:width withFloat:height withBOOL:isCircle];
}
...
- (void)refreshTint {
  ...
  [((TuxkidsTuxblocksCoreLayersImageLayerTintable *) nil_chk(imageLayer__)) setTintWithInt:tint];
}
...
- (id)initTuxkidsTuxblocksCoreButtonWithPlaynCoreImage:(id<PlaynCoreImage>)image
  ...
  if ((self = [super init])) {
    ...
    self.height_ = height;
    self.isCircle_ = isCircle;
    imageLayer__ = [[TuxkidsTuxblocksCoreLayersImageLayerTintable alloc] init];
    [self setImageWithPlaynCoreImage:image];
    [((TuxkidsTuxblocksCoreLayersImageLayerTintable *) nil_chk(imageLayer__)) addListenerWithPlaynCorePointer_Listener:[[TuxkidsTuxblocksCoreButton_PointerListener alloc] initWithTuxkidsTuxblocksCoreButton:self]];
...
- (void)destroy {
  [((TuxkidsTuxblocksCoreLayersImageLayerTintable *) nil_chk(imageLayer__)) destroy];
}
...
- (void)adjustScale {
  [((TuxkidsTuxblocksCoreLayersImageLayerTintable *) nil_chk(imageLayer__)) setScaleWithFloat:width__ / [((id<PlaynCoreImage>) nil_chk([((TuxkidsTuxblocksCoreLayersImageLayerTintable *) nil_chk(imageLayer__)) image])) width] withFloat:height__ / [((id<PlaynCoreImage>) nil_chk([((TuxkidsTuxblocksCoreLayersImageLayerTintable *) nil_chk(imageLayer__)) image])) height]];
}
...
- (BOOL)insideLocalWithPlaynCorePointer_Event:(id<PlaynCorePointer_Event>)event {
  float dw = [((id<PlaynCoreImage>) nil_chk([this$0_ image])) width] / 2;
  float dh = [((id<PlaynCoreImage>) nil_chk([this$0_ image])) height] / 2;
...
- (void)onSuccessWithId:(id<PlaynCoreImage>)result {
  [((TuxkidsTuxblocksCoreLayersImageLayerTintable *) nil_chk(this$0_.imageLayer_)) setOriginWithFloat:[((id<PlaynCoreImage>) nil_chk(result)) width] / 2 withFloat:[((id<PlaynCoreImage>) nil_chk(result)) height] / 2];
  [this$0_ adjustScale];
}
