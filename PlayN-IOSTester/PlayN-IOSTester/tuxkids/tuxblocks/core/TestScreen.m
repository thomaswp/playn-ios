...
- (void)wasAdded {
  ...
  l2_ = [[TuxkidsTuxblocksCoreLayersImageLayerTintable alloc] initWithPlaynCoreImage:test];
  [((id<PlaynCoreGroupLayer>) nil_chk(layer_)) addWithPlaynCoreLayer:[((TuxkidsTuxblocksCoreLayersImageLayerTintable *) nil_chk(l2_)) layerAddable]];
  [((TuxkidsTuxblocksCoreLayersImageLayerTintable *) nil_chk(l2_)) setTintWithInt:tint_];
  [((TuxkidsTuxblocksCoreLayersImageLayerTintable *) nil_chk(l2_)) setTxWithFloat:[self width] - [((TuxkidsTuxblocksCoreLayersImageLayerTintable *) nil_chk(l2_)) width]];
}
...
- (void)paintWithPlaynCoreUtilClock:(id<PlaynCoreUtilClock>)clock {
  ...
  [((TuxkidsTuxblocksCoreLayersImageLayerTintable *) nil_chk(l2_)) setTintWithInt:[TripleplayUtilColors WHITE] withInt:tint_ withFloat:alpha];
}
