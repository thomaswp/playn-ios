...
#ifndef _TuxkidsTuxblocksCoreButton_H_
#define _TuxkidsTuxblocksCoreButton_H_
...
@interface TuxkidsTuxblocksCoreButton : TuxkidsTuxblocksCorePlayNObject < TuxkidsTuxblocksCoreUtilsPositioned > {
 @public
  TuxkidsTuxblocksCoreLayersImageLayerTintable *imageLayer__;
...
@property (nonatomic, strong) TuxkidsTuxblocksCoreLayersImageLayerTintable *imageLayer_;
...
@protocol TuxkidsTuxblocksCoreButton_OnReleasedListener < NSObject, JavaObject >
- (void)onReleaseWithPlaynCorePointer_Event:(id<PlaynCorePointer_Event>)event
                                   withBOOL:(BOOL)inButton;
@end

@protocol TuxkidsTuxblocksCoreButton_OnPressedListener < NSObject, JavaObject >
- (void)onPressWithPlaynCorePointer_Event:(id<PlaynCorePointer_Event>)event;
@end

@protocol TuxkidsTuxblocksCoreButton_OnDragListener < NSObject, JavaObject >
...
#endif // _TuxkidsTuxblocksCoreButton_H_
