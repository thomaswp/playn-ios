...
- (void)startPlacementWithTuxkidsTuxblocksCoreDefenseTowerTower:(TuxkidsTuxblocksCoreDefenseTowerTower *)toPlace {
  ...
  [((TuxkidsTuxblocksCoreLayersImageLayerTintable *) nil_chk([((TuxkidsTuxblocksCoreDefenseTowerTower *) nil_chk(toPlace)) layer])) setVisibleWithBOOL:NO];
...
- (void)updatePlacementWithFloat:(float)globalX
  ...
  if (toPlace_ != nil) {
    ...
    [((TuxkidsTuxblocksCoreLayersImageLayerTintable *) nil_chk([toPlace_ layer])) setVisibleWithBOOL:![self isOutOfBoundsWithFloat:placeX withFloat:placeY]];
    [self updateToPlace];
  }
}
...
- (BOOL)endPlacementWithFloat:(float)globalX
  ...
  if (canPlace) {
    ...
    [((TuxkidsTuxblocksCoreLayersImageLayerTintable *) nil_chk([toPlace_ layer])) destroy];
  }
  toPlace_ = nil;
  [((id<PlaynCoreImageLayer>) nil_chk(toPlaceRadius_)) destroy];
  toPlaceRadius_ = nil;
...
- (void)updateToPlace {
  ...
  [((TuxkidsTuxblocksCoreLayersImageLayerTintable *) nil_chk([((TuxkidsTuxblocksCoreDefenseTowerTower *) nil_chk(toPlace_)) layer])) setAlphaWithFloat:[self canPlace] ? 1 : 0.5f];
  ...
  (void) [((id<PlaynCoreImageLayer>) nil_chk(toPlaceRadius_)) setVisibleWithBOOL:[((TuxkidsTuxblocksCoreLayersImageLayerTintable *) nil_chk([((TuxkidsTuxblocksCoreDefenseTowerTower *) nil_chk(toPlace_)) layer])) visible] && [((TuxkidsTuxblocksCoreLayersImageLayerTintable *) nil_chk([((TuxkidsTuxblocksCoreDefenseTowerTower *) nil_chk(toPlace_)) layer])) alpha] == 1];
}
