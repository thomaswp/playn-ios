...
- (float)width {
  return [((TuxkidsTuxblocksCoreLayersImageLayerTintable *) nil_chk(layer__)) width];
}

- (float)height {
  return [((TuxkidsTuxblocksCoreLayersImageLayerTintable *) nil_chk(layer__)) height];
}
...
- (void)setCoordinatesWithInt:(int)row
  ...
  [((TuxkidsTuxblocksCoreLayersImageLayerTintable *) nil_chk(layer__)) setTranslationWithFloat:col * [((TuxkidsTuxblocksCoreDefenseGrid *) nil_chk(grid_)) cellSize] + ([self baseWidth] - [self width]) / 2 withFloat:row * [((TuxkidsTuxblocksCoreDefenseGrid *) nil_chk(grid_)) cellSize] + ([self baseHeight] - [self height])];
...
- (TuxkidsTuxblocksCoreDefenseTowerTower *)previewWithTuxkidsTuxblocksCoreDefenseGrid:(TuxkidsTuxblocksCoreDefenseGrid *)grid {
  ...
  self.grid = grid;
  layer__ = [[TuxkidsTuxblocksCoreLayersImageLayerTintable alloc] initWithPlaynCoreImage:[self createImageWithFloat:[((TuxkidsTuxblocksCoreDefenseGrid *) nil_chk(grid)) cellSize] withInt:[TripleplayUtilColors WHITE]]];
  [((TuxkidsTuxblocksCoreLayersImageLayerTintable *) nil_chk(layer__)) setTintWithInt:[((TuxkidsTuxblocksCoreDefenseGrid *) nil_chk(grid)) towerColor]];
  return self;
}
