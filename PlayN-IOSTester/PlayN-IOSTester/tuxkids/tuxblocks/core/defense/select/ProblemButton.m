...
+ (id<PlaynCoreImage>)createImageWithTuxkidsTuxblocksCoreDefenseSelectProblem:(TuxkidsTuxblocksCoreDefenseSelectProblem *)problem
  ...
  TuxkidsTuxblocksCoreSolveExpressionExpressionWriter *leftEW = [((TuxkidsTuxblocksCoreSolveExpressionExpression *) nil_chk([((TuxkidsTuxblocksCoreSolveExpressionEquation *) nil_chk([((TuxkidsTuxblocksCoreDefenseSelectProblem *) nil_chk(problem)) equation])) leftHandSide])) getExpressionWriterWithPlaynCoreTextFormat:textFormat];
  TuxkidsTuxblocksCoreSolveExpressionExpressionWriter *rightEW = [((TuxkidsTuxblocksCoreSolveExpressionExpression *) nil_chk([((TuxkidsTuxblocksCoreSolveExpressionEquation *) nil_chk([((TuxkidsTuxblocksCoreDefenseSelectProblem *) nil_chk(problem)) equation])) rightHandSide])) getExpressionWriterWithPlaynCoreTextFormat:textFormat];
  id<PlaynCoreTextLayout> eqLayout = [((id<PlaynCoreGraphics>) nil_chk([PlaynCorePlayN graphics])) layoutTextWithNSString:@"=" withPlaynCoreTextFormat:textFormat];
