...
#ifndef _TuxkidsTuxblocksCoreDefenseWalkerWalker_H_
#define _TuxkidsTuxblocksCoreDefenseWalkerWalker_H_
...
@interface TuxkidsTuxblocksCoreDefenseWalkerWalker : TuxkidsTuxblocksCoreDefenseDiscreteGridObject {
 @public
  ...
  TuxkidsTuxblocksCoreLayersImageLayerTintable *layer__;
  float hp_;
  float alpha_;
  float walkingMs_;
  BOOL placed_;
...
@property (nonatomic, strong) TuxkidsTuxblocksCoreLayersImageLayerTintable *layer_;
...
#endif // _TuxkidsTuxblocksCoreDefenseWalkerWalker_H_
