...
- (id<PlaynCoreLayer>)layerAddable {
  return [((TuxkidsTuxblocksCoreLayersImageLayerTintable *) nil_chk(layer__)) layerAddable];
}

- (TuxkidsTuxblocksCoreLayersImageLayerTintable *)layer {
  return layer__;
}
...
- (BOOL)destroyed {
  return [((id<PlaynCoreLayer>) nil_chk([((TuxkidsTuxblocksCoreLayersImageLayerTintable *) nil_chk(layer__)) layerAddable])) destroyed];
}

- (void)setDepthWithFloat:(float)depth {
  [((TuxkidsTuxblocksCoreLayersImageLayerTintable *) nil_chk(layer__)) setDepthWithFloat:depth];
}
...
- (void)createSprite {
  ...
  layer__ = [[TuxkidsTuxblocksCoreLayersImageLayerTintable alloc] initWithPlaynCoreImage:image];
  [self updateWithInt:0];
}
...
- (BOOL)updateWithInt:(int)delta {
  ...
  if (hp_ == 0) {
    if ([((TuxkidsTuxblocksCoreLayersImageLayerTintable *) nil_chk(layer__)) alpha] < 0.01f) {
      [((TuxkidsTuxblocksCoreLayersImageLayerTintable *) nil_chk(layer__)) destroy];
      return YES;
    }
    return NO;
  }
  ...
  [((TuxkidsTuxblocksCoreLayersImageLayerTintable *) nil_chk(layer__)) setTintWithInt:[TripleplayUtilColors WHITE] withInt:[((TuxkidsTuxblocksCoreDefenseGrid *) nil_chk(grid_)) towerColor] withFloat:hp_ / [self getMaxHp]];
  [((TuxkidsTuxblocksCoreLayersImageLayerTintable *) nil_chk(layer__)) setAlphaWithFloat:alpha_];
...
- (void)paintWithPlaynCoreUtilClock:(id<PlaynCoreUtilClock>)clock {
  ...
  if (hp_ > 0) {
    ...
    [((TuxkidsTuxblocksCoreLayersImageLayerTintable *) nil_chk(layer__)) setAlphaWithFloat:[TuxkidsTuxblocksCorePlayNObject lerpTimeWithFloat:[((TuxkidsTuxblocksCoreLayersImageLayerTintable *) nil_chk(layer__)) alpha] withFloat:0 withFloat:0.995f withFloat:dt]];
  }
