...
- (void)updateMovementWithFloat:(float)perc {
  ...
  [((TuxkidsTuxblocksCoreLayersImageLayerTintable *) nil_chk(layer__)) setOriginWithFloat:ox withFloat:oy];
  [((TuxkidsTuxblocksCoreLayersImageLayerTintable *) nil_chk(layer__)) setTranslationWithFloat:x withFloat:y];
  [((TuxkidsTuxblocksCoreLayersImageLayerTintable *) nil_chk(layer__)) setScaleWithFloat:scaleX withFloat:scaleY];
}
