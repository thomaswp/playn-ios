...
- (BOOL)equalsWithTuxkidsTuxblocksCoreUtilsHashCode:(TuxkidsTuxblocksCoreUtilsHashCode *)hash_ {
  ...
  if ([((id<TuxkidsTuxblocksCoreUtilsHashCode_Hashable>) nil_chk(self.hashable)) getClass] != [((id<TuxkidsTuxblocksCoreUtilsHashCode_Hashable>) nil_chk(hashable)) getClass]) return NO;
