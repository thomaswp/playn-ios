...
#ifndef _TuxkidsTuxblocksCoreUtilsHashCode_H_
#define _TuxkidsTuxblocksCoreUtilsHashCode_H_
...
@protocol TuxkidsTuxblocksCoreUtilsHashCode_Hashable < NSObject, JavaObject >
- (void)addFieldsWithTuxkidsTuxblocksCoreUtilsHashCode:(TuxkidsTuxblocksCoreUtilsHashCode *)hashCode;
@end

#endif // _TuxkidsTuxblocksCoreUtilsHashCode_H_
