...
+ (id<PlaynCoreImage>)tintImageWithPlaynCoreImage:(id<PlaynCoreImage>)image
  ...
  for (int i = 0; i < (int) [((IOSIntArray *) nil_chk(rgb)) count]; i++) {
    (*[((IOSIntArray *) nil_chk(rgb)) intRefAtIndex:i]) = [TuxkidsTuxblocksCoreUtilsCanvasUtils blendTintWithInt:[((IOSIntArray *) nil_chk(rgb)) intAtIndex:i] withInt:tint withFloat:perc];
  }
...
+ (int)blendAddativeWithInt:(int)c1
                    withInt:(int)c2
                  withFloat:(float)perc {
  return [PlaynCoreColor argbWithInt:[JavaLangMath maxWithInt:[PlaynCoreColor alphaWithInt:c1] withInt:[PlaynCoreColor alphaWithInt:c2]] withInt:[JavaLangMath minWithInt:(int) ([PlaynCoreColor redWithInt:c1] + [PlaynCoreColor redWithInt:c2] * perc) withInt:255] withInt:[JavaLangMath minWithInt:(int) ([PlaynCoreColor greenWithInt:c1] + [PlaynCoreColor greenWithInt:c2] * perc) withInt:255] withInt:[JavaLangMath minWithInt:(int) ([PlaynCoreColor blueWithInt:c1] + [PlaynCoreColor blueWithInt:c2] * perc) withInt:255]];
}
...
+ (void)rgbToHsvWithInt:(int)color
  ...
  float h, s, v;
  float min, max, delta;
  min = [JavaLangMath minWithInt:[JavaLangMath minWithInt:r withInt:g] withInt:b];
  max = [JavaLangMath maxWithInt:[JavaLangMath maxWithInt:r withInt:g] withInt:b];
  v = max / 255.0f;
  delta = max - min;
  if (max != 0) s = delta / max;
  else {
    (*[((IOSFloatArray *) nil_chk(hsv)) floatRefAtIndex:0]) = 0;
    (*[((IOSFloatArray *) nil_chk(hsv)) floatRefAtIndex:1]) = 0;
    (*[((IOSFloatArray *) nil_chk(hsv)) floatRefAtIndex:2]) = 0;
    return;
  }
  if (delta == 0) {
    (*[((IOSFloatArray *) nil_chk(hsv)) floatRefAtIndex:0]) = 0;
    (*[((IOSFloatArray *) nil_chk(hsv)) floatRefAtIndex:1]) = 0;
    (*[((IOSFloatArray *) nil_chk(hsv)) floatRefAtIndex:2]) = max / 255.0f;
    return;
  }
  ...
  h /= 6;
  while (h < 0) h += 1;
  (*[((IOSFloatArray *) nil_chk(hsv)) floatRefAtIndex:0]) = h;
  (*[((IOSFloatArray *) nil_chk(hsv)) floatRefAtIndex:1]) = s;
  (*[((IOSFloatArray *) nil_chk(hsv)) floatRefAtIndex:2]) = v;
}
...
+ (id<PlaynCoreImage>)createStringWithPlaynCoreTextFormat:(PlaynCoreTextFormat *)format
  ...
  if ([((NSString *) nil_chk(text)) isEmpty]) [((id<PlaynCoreLog>) nil_chk([PlaynCorePlayN log])) warnWithNSString:@"Creating image with empty String."];
  ...
  float width = [JavaLangMath maxWithFloat:[((id<PlaynCoreTextLayout>) nil_chk(layout)) width] withFloat:1];
  float height = [JavaLangMath maxWithFloat:[((id<PlaynCoreTextLayout>) nil_chk(layout)) height] withFloat:1];
